 ...
 */
     ...
     * @secure
     */
    dictionaryUpdateDelete: (organizationCode: string, code: string, params: RequestParams = {}) =>
      this.request<void, any>({
 ...
 */
     ...
     * @secure
     */
    domainUpdateDeleteVersion: (organizationCode: string, code: string, version: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/Domain/v3/${organizationCode}/${code}/${version}`,
        method: 'DELETE',
        secure: true,
     ...
     * @secure
     */
    domainUpdateDelete: (organizationCode: string, code: string, params: RequestParams = {}) =>
      this.request<void, any>({
     ...
     * @deprecated
     */
    domainWithClassificationTreeV2: (
      query: {
        /** Required parameter to select the domain. */
        namespaceUri: string;
        /** Set to true if you want a tree of classifications, set to false to get a flat list of classifications */
