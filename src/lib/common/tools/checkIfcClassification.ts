...
import type { BsddDictionary, URI } from '../IfcData/bsddBridgeData';
import type { Association, IfcClassification, IfcClassificationReference, IfcEntity } from '../IfcData/ifc';
