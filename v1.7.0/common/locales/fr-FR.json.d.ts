declare const _default: {
  "translation": {
    "appTitle": "bSDD Gestionnaire de données BIM",
    ...
    "editEntities": "Modifier",
    "selectEntities": "Sélectionner",
    "selectEntitiesInstruction": "Sélectionner des objets",
    "editEntitiesInstruction": "Attacher au type",
    ...
    "bsddSearch": {
      "property": {
        "tooltipEditInstance": "Il n'est pas possible de modifier les propriétés d'instance pour les types",
        "setAsInstanceCheckboxTooltip": "Définir comme propriété d'instance"
      }
    }
  }
};
