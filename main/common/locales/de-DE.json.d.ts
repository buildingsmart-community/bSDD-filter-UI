declare const _default: {
  "translation": {
    "appTitle": "bSDD BIM-Daten-Manager",
    ...
    "editEntities": "Bearbeiten",
    "selectEntities": "Auswählen",
    "selectEntitiesInstruction": "Objekte auswählen",
    "editEntitiesInstruction": "An Typ anhängen",
    ...
    "appInfoLabel": "Informationen und Dokumentation",
    "appInfoInstruction": "Informationen über dieses Plugin",
    "bsddSearch": {
      "property": {
        "tooltipEditInstance": "Das Bearbeiten von Instanzeigenschaften für Typen ist nicht möglich",
        "setAsInstanceCheckboxTooltip": "Als Instanzeigenschaft festlegen"
      }
    }
  }
};
