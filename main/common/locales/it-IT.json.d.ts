declare const _default: {
  "translation": {
    ...
    "editEntities": "Modifica",
    "selectEntities": "Seleziona",
    "selectEntitiesInstruction": "Seleziona oggetti",
    "editEntitiesInstruction": "Collega al tipo",
    ...
    "appInfoLabel": "Informazioni e documentazione",
    "appInfoInstruction": "Informazioni su questo plugin",
    "bsddSearch": {
      "property": {
        "tooltipEditInstance": "Non è possibile modificare le proprietà di istanza per i tipi",
        "setAsInstanceCheckboxTooltip": "Imposta come proprietà di istanza"
      }
    }
  }
};
