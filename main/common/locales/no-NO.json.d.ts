declare const _default: {
  "translation": {
    "appTitle": "bSDD BIM-datamanager",
    "updateSelection": "Oppdater valg",
    "apply": "Bruk",
    "save": "Lagre",
    "cancel": "Avbryt",
    ...
    "editEntities": "Rediger",
    "selectEntities": "Velg",
    "selectEntitiesInstruction": "Velg objekter",
    "editEntitiesInstruction": "Knytt til type",
    ...
    "bsddSearch": {
      "property": {
        "tooltipEditInstance": "Redigering av instansegenskaper for typer er ikke mulig",
        "setAsInstanceCheckboxTooltip": "Sett som instansegenskap"
      }
    }
  }
};
