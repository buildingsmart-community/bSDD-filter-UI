declare const _default: {
  "translation": {
    "appTitle": "Gerenciador de dados BIM bSDD",
    ...
    "editEntities": "Editar",
    "selectEntities": "Selecionar",
    "selectEntitiesInstruction": "Selecione objetos",
    "editEntitiesInstruction": "Anexar ao tipo",
    ...
    "appInfoLabel": "Informação e documentação",
    "appInfoInstruction": "Informações sobre este plugin",
    "bsddSearch": {
      "property": {
        "tooltipEditInstance": "Não é possível editar propriedades de instância para tipos",
        "setAsInstanceCheckboxTooltip": "Definir como propriedade de instância"
      }
    }
  }
};
