declare const _default: {
  "translation": {
    "appTitle": "Správce dat BIM bSDD",
    "updateSelection": "Aktualizovat výběr",
    "apply": "Použít",
    "save": "Uložit",
    "cancel": "Zrušit",
    "groupBy": "Seskupit",
    ...
    "editEntities": "Upravit",
    "selectEntities": "Vybrat",
    "selectEntitiesInstruction": "Vyberte objekty",
    "editEntitiesInstruction": "Připojit k typu",
