...
import b, { createContext as Ht, useContext as ft, useState as q, useRef as V, useEffect as W, useMemo as Mt, useCallback as Q, useLayoutEffect as bo, useId as Ru, forwardRef as ie, cloneElement as ln, Children as Vm, createElement as Pc } from "react";
import * as zm from "react-dom";
import Iu, { flushSync as Ds, createPortal as Gm, unstable_batchedUpdates as Wm } from "react-dom";
function Ou(e) {
...
), Rc = Symbol.for("react-redux-context"), Ic = typeof globalThis < "u" ? globalThis : (
...
var Lu = /* @__PURE__ */ Rs(), Mu = sg, ag = (e) => {
  Mu = e;
}, cg = (e, t) => e === t;
function lg(e = Bt) {
  const t = e === Bt ? Lu : Rs(e), n = (r, o = {}) => {
...
var yg = /* @__PURE__ */ _u();
function vg(e = Bt) {
  const t = e === Bt ? yg : _u(e), n = () => t().dispatch;
  return Object.assign(n, {
    withTypes: () => n
  }), n;
}
...
class Gr {
  ...
  create(t) {
    return new Gr(this.logger, {
      prefix: `${this.prefix}:${t}:`,
      ...this.options
    });
  }
  clone(t) {
    return t = t || this.options, t.prefix = t.prefix || this.prefix, new Gr(this.logger, t);
  }
}
var gt = new Gr();
class vo {
...
function Eg(e, t, n) {
  const r = Wr(e, n);
  return r !== void 0 ? r : Wr(t, n);
}
function ku(e, t, n) {
  for (const r in t)
    r !== "__proto__" && r !== "constructor" && (r in e ? typeof e[r] == "string" || e[r] instanceof String || typeof t[r] == "string" || t[r] instanceof String ? n && (e[r] = t[r]) : ku(e[r], t[r], n) : e[r] = t[r]);
  return e;
}
function pn(e) {
  return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
...
class qr extends vo {
  ...
  extractFromKey(t, n) {
    ...
    const s = r && t.indexOf(r) > -1, a = !this.options.userDefinedKeySeparator && !n.keySeparator && !this.options.userDefinedNsSeparator && !n.nsSeparator && !Ig(t, r, o);
    if (s && !a) {
  ...
  translate(t, n, r) {
    ...
    if (x && f && (typeof f != "string" && typeof f != "boolean" && typeof f != "number") && h.indexOf(g) < 0 && !(typeof v == "string" && g === "[object Array]")) {
      ...
      const M = (n.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && S ? void 0 : f, k = P && $ !== f && this.options.updateMissing;
      if (S || w || k) {
        ...
        const I = (F, A, H) => {
          const K = P && H !== f ? H : M;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(F, c, A, K, k, n) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(F, c, A, K, k, n), this.emit("missingKey", F, c, A, f);
        };
...
class Mg {
  ...
  interpolate(t, n, r, o) {
    ...
    const u = (m) => {
      ...
      return this.format(_c(n, c, h, this.options.keySeparator, this.options.ignoreJSONStructure), v, r, {
        ...o,
        ...n,
        interpolationkey: h
      });
...
class Yn extends vo {
  ...
  init() {
    ...
    if (this.format = this.options.interpolation.format, r || (r = Rr), this.options.fallbackLng && !this.services.languageDetector && !this.options.lng) {
  ...
  loadResources(t) {
    let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Rr;
  ...
  reloadResources(t, n, r) {
    const o = Fn();
    return t || (t = this.languages), n || (n = this.options.ns), r || (r = Rr), this.services.backendConnector.reload(t, n, (i) => {
      o.resolve(), r(i);
    }), o;
  }
  use(t) {
  ...
  dir(t) {
    if (t || (t = this.resolvedLanguage || (this.languages && this.languages.length > 0 ? this.languages[0] : this.language)), !t)
      return "rtl";
    const n = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new Lc(kc());
  ...
  cloneInstance() {
    let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Rr;
...
function Zi() {
  for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
    t[n] = arguments[n];
  typeof t[0] == "string" && Bc[t[0]] || (typeof t[0] == "string" && (Bc[t[0]] = /* @__PURE__ */ new Date()), Vg(...t));
}
const Bu = (e, t) => () => {
  if (e.isInitialized)
    t();
...
const Wg = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Hg = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, Ug = (e) => Hg[e], qg = (e) => e.replace(Wg, Ug);
let es = {
...
const D = Vu("rem", { shouldScale: !0 }), zc = Vu("em");
function As(e) {
...
const mr = typeof document < "u" ? bo : W;
function jt(e, t) {
  const n = V(!1);
  W(
    () => () => {
...
const _h = ({
  ...
  if (n === "outline")
    return o.isThemeColor ? o.shade === void 0 ? {
      ...
      background: "transparent",
      hover: Ie(t.colors[o.color][o.shade], 0.05),
...
}, Wc = "-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji", Ls = {
  scale: 1,
  fontSmoothing: !0,
  focusRing: "auto",
  white: "#fff",
...
const nd = (e) => {
  ...
  gn(o.variables, e.breakpoints, "breakpoint"), gn(o.variables, e.spacing, "spacing"), gn(o.variables, e.fontSizes, "font-size"), gn(o.variables, e.lineHeights, "line-height"), gn(o.variables, e.shadows, "shadow"), gn(o.variables, e.radius, "radius"), e.colors[e.primaryColor].forEach((s, a) => {
    ...
    o.light["--mantine-color-dimmed"] = "var(--mantine-color-gray-6)", o.light[`--mantine-color-${s}-text`] = `var(--mantine-color-${s}-filled)`, o.light[`--mantine-color-${s}-filled`] = `var(--mantine-color-${s}-${n})`, o.light[`--mantine-color-${s}-filled-hover`] = a, o.light[`--mantine-color-${s}-light`] = Ie(
      e.colors[s][n],
      0.1
    ), o.light[`--mantine-color-${s}-light-hover`] = Ie(
      e.colors[s][n],
      0.12
    ), o.light[`--mantine-color-${s}-light-color`] = `var(--mantine-color-${s}-${n})`, o.light[`--mantine-color-${s}-outline`] = `var(--mantine-color-${s}-${n})`, o.light[`--mantine-color-${s}-outline-hover`] = Ie(
      e.colors[s][n],
      0.05
    ), o.dark["--mantine-color-dimmed"] = "var(--mantine-color-dark-2)", o.dark[`--mantine-color-${s}-text`] = `var(--mantine-color-${s}-4)`, o.dark[`--mantine-color-${s}-filled`] = `var(--mantine-color-${s}-${t})`, o.dark[`--mantine-color-${s}-filled-hover`] = c, o.dark[`--mantine-color-${s}-light`] = Ie(
      e.colors[s][Math.max(0, t - 2)],
      0.15
    ), o.dark[`--mantine-color-${s}-light-hover`] = Ie(
      e.colors[s][Math.max(0, t - 2)],
      0.2
      ...
      t - 4,
      0
    )})`, o.dark[`--mantine-color-${s}-outline-hover`] = Ie(
...
function Wh({ theme: e, generator: t }) {
...
function Hh(e) {
  ...
  return bt(e.variables).forEach((n) => {
    Ri.variables[n] !== e.variables[n] && (t.variables[n] = e.variables[n]);
  }), bt(e.light).forEach((n) => {
    Ri.light[n] !== e.light[n] && (t.light[n] = e.light[n]);
  }), bt(e.dark).forEach((n) => {
    Ri.dark[n] !== e.dark[n] && (t.dark[n] = e.dark[n]);
  }), t;
}
function Uh(e) {
  return `
...
function rd({ cssVariablesSelector: e }) {
  const t = pt(), n = Ts(), r = Ah(), o = Wh({ theme: t, generator: r }), i = e === ":root", s = i ? Hh(o) : o, a = Gh(s, e);
...
function Kh({
  ...
  const o = V(), [i, s] = q(() => e.get(t)), a = r || i, c = Q(
    (u) => {
  ...
  return W(() => (e.subscribe(c), e.unsubscribe), [e.subscribe, e.unsubscribe]), mr(() => {
    Bn(e.get(t), n);
  }, []), W(() => {
    var d;
    if (r)
...
function od({
  ...
  return Yh({
    ...
    /* @__PURE__ */ b.createElement(td, { theme: e }, r && /* @__PURE__ */ b.createElement(rd, { cssVariablesSelector: o }), /* @__PURE__ */ b.createElement(zh, null), t)
  );
}
  ...
  return vb(
    bt(e).reduce(
      (r, o) => {
        ...
        if (!wb(e[o]))
          return s.forEach((l) => {
            r.inlineStyles[l] = Ii[i.type](a, n);
          }), r;
        r.hasResponsiveStyles = !0;
        const c = Sb(e[o]);
        return s.forEach((l) => {
          a && (r.styles[l] = Ii[i.type](a, n)), c.forEach((u) => {
...
const cd = ie(
  ({
    ...
    const m = pt(), g = e || "div", { styleProps: h, rest: v } = gr(f), x = Pb(), y = Eb({
      ...
      "data-variant": o,
      "data-size": zu(s) ? void 0 : s || void 0,
      ...ad(i),
      ...v
    };
...
const Nb = {
  ...
  return p === 0 ? r ? /* @__PURE__ */ b.createElement(z, { ...l }, n) : null : /* @__PURE__ */ b.createElement(z, { ...m({ style: _s(s, u), ref: t, ...l }) }, /* @__PURE__ */ b.createElement(
    "div",
    {
      style: {
        opacity: r || !c ? 1 : 0,
...
function Jc(e, t, n = "ltr") {
  const r = Co(t), o = t.scrollbar.paddingStart + t.scrollbar.paddingEnd, i = t.scrollbar.size - o, s = t.content - t.viewport, a = i - r, c = n === "ltr" ? [0, s] : [s * -1, 0], l = _b(e, c);
  return pd([0, s], [0, a])(l);
}
...
const [Fb, gd] = Kt(
  ...
  }, [x, p, y, w]), W(S, [n, S]), yn(p, C), yn(f.content, C), /* @__PURE__ */ b.createElement(
    Fb,
    {
      value: {
        scrollbar: p,
  ...
  (e, t) => {
    const { sizes: n, onSizesChange: r, style: o, ...i } = e, s = tt(), [a, c] = q(), l = V(null), u = Ae(t, l, s.onScrollbarXChange);
    return W(() => {
  ...
  (e, t) => {
    const { sizes: n, onSizesChange: r, style: o, ...i } = e, s = tt(), [a, c] = b.useState(), l = V(null), u = Ae(t, l, s.onScrollbarYChange);
    return W(() => {
      l.current && c(getComputedStyle(l.current));
    }, [l]), /* @__PURE__ */ b.createElement(
      hd,
  ...
  const { orientation: n = "vertical", ...r } = e, { dir: o } = hr(), i = tt(), s = V(null), a = V(0), [c, l] = q({
    content: 0,
    viewport: 0,
  ...
  (e, t) => {
    ...
    return b.useEffect(() => (a ? i(!0) : s(!0), () => {
      a ? i(!1) : s(!1);
    }), [a, i, s]), o.type === "hover" ? /* @__PURE__ */ b.createElement(Vb, { ...r, ref: t, forceMount: n }) : o.type === "scroll" ? /* @__PURE__ */ b.createElement(zb, { ...r, ref: t, forceMount: n }) : o.type === "auto" ? /* @__PURE__ */ b.createElement(bd, { ...r, ref: t, forceMount: n }) : o.type === "always" ? /* @__PURE__ */ b.createElement(ks, { ...r, ref: t }) : null;
  }
);
function Gb(e, t = () => {
}) {
...
const Wb = ie((e, t) => {
  const { style: n, ...r } = e, o = tt(), i = gd(), { onThumbPositionChange: s } = i, a = Ae(t, (u) => i.onThumbChange(u)), c = V(), l = xo(() => {
  ...
  (e, t) => {
    ...
    return n || o.hasThumb ? /* @__PURE__ */ b.createElement(Wb, { ref: t, ...r }) : null;
  }
), yd = ie(
...
const Bs = U((e, t) => {
  ...
  return /* @__PURE__ */ b.createElement(z, { ...x, ref: t, style: [{ display: "flex" }, h] }, /* @__PURE__ */ b.createElement(z, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ b.createElement(
    br,
    {
      classNames: r,
      styles: o,
...
function Zc(e, t, n) {
  ...
  const i = dn(t), s = zs(t), a = Vs(s), c = dt(t), l = i === "y", u = r.x + r.width / 2 - o.width / 2, d = r.y + r.height / 2 - o.height / 2, f = r[a] / 2 - o[a] / 2;
  let p;
  switch (c) {
    case "top":
      p = {
...
async function Ws(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = Dt(t, e), m = Gs(p), h = a[f ? d === "floating" ? "reference" : "floating" : d], v = vn(await i.getClippingRect({
...
const el = (e) => ({
  ...
  async fn(t) {
    ...
    const d = Gs(u), f = {
      x: n,
      y: r
    }, p = zs(o), m = Vs(p), g = await s.getDimensions(l), h = p === "y", v = h ? "top" : "left", x = h ? "bottom" : "right", y = h ? "clientHeight" : "clientWidth", w = i.reference[m] + i.reference[p] - f[p] - i.floating[m], S = f[p] - i.reference[p], C = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(l));
    let P = C ? C[y] : 0;
    (!P || !await (s.isElement == null ? void 0 : s.isElement(C))) && (P = a.floating[y] || i.floating[m]);
    const E = w / 2 - S / 2, N = P / 2 - g[m] / 2 - 1, $ = ut(d[v], N), T = ut(d[x], N), M = $, k = P - g[m] - T, O = P / 2 - g[m] / 2 + E, L = as(M, O, k), I = !c.arrow && On(o) != null && O != L && i.reference[m] / 2 - (O < M ? $ : T) - g[m] / 2 < 0, F = I ? O < M ? O - M : O - k : 0;
    return {
      [p]: f[p] + F,
      data: {
        [p]: L,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if (E = [...E, {
        ...
        var N, $;
        const M = (((N = i.flip) == null ? void 0 : N.index) || 0) + 1, k = S[M];
        if (k)
          return {
            data: {
              index: M,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: c,
        y: l
      } = Dt(e, t), u = Array.from(await (i.getClientRects == null ? void 0 : i.getClientRects(r.reference)) || []), d = ty(u), f = vn(Sd(u)), p = Gs(a);
      function m() {
        ...
        if (d.length >= 2) {
          if (dn(n) === "y") {
            const $ = d[0], T = d[d.length - 1], M = dt(n) === "top", k = $.top, O = T.bottom, L = M ? $.left : T.left, I = M ? $.right : T.right, F = I - L, A = O - k;
            return {
              top: k,
              bottom: O,
              left: L,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: r
      }, u = await Ws(t, c), d = dn(dt(o)), f = js(d);
      let p = l[f], m = l[d];
      if (i) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        ...a
      } = Dt(e, t), c = await Ws(t, a), l = dt(n), u = On(n), d = dn(n) === "y", {
        width: f,
        height: p
      } = r.floating;
      let m, g;
...
function Ct(e, t, n) {
  ...
  const o = Dd(e), i = o === ((r = e.ownerDocument) == null ? void 0 : r.body), s = ze(o);
...
function sn(e, t, n, r) {
  ...
  let s = Vt(1);
  t && (r ? Rt(r) && (s = bn(r)) : s = bn(e));
  const a = cy(i, n, r) ? Id(i) : Vt(0);
  let c = (o.left + a.x) / s.x, l = (o.top + a.y) / s.y, u = o.width / s.x, d = o.height / s.y;
  if (i) {
    const f = ze(i), p = r && Rt(r) ? ze(r) : r;
...
function ly(e) {
  ...
  const c = Vt(0);
  if ((o || !o && r !== "fixed") && ((zt(n) !== "body" || yr(i)) && (s = Po(n)), wt(n))) {
    const l = sn(n);
...
function Od(e) {
  return sn(At(e)).left + Po(e).scrollLeft;
}
function dy(e) {
  const t = At(e), n = Po(e), r = e.ownerDocument.body, o = xe(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), i = xe(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight);
...
function Ad(e, t) {
  const n = wn(e);
  return n === t || !Rt(n) || Eo(n) ? !1 : et(n).position === "fixed" || Ad(n, t);
}
function my(e, t) {
  const n = t.get(e);
  if (n)
    return n;
  let r = Ct(e, [], !1).filter((a) => Rt(a) && zt(a) !== "body"), o = null;
...
function by(e, t, n) {
  const r = wt(t), o = At(t), i = n === "fixed", s = sn(e, !0, i, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function Nd(e, t) {
  ...
  for (; r && iy(r) && et(r).position === "static"; )
    r = rl(r, t);
  return r && (zt(r) === "html" || zt(r) === "body" && et(r).position === "static" && !Us(r)) ? n : r || sy(e) || n;
}
...
function Ey(e) {
  ...
  eo(f, r) || p(r);
  const [m, g] = R.useState(null), [h, v] = R.useState(null), x = R.useCallback((I) => {
    I != C.current && (C.current = I, g(I));
  }, [g]), y = R.useCallback((I) => {
    I !== P.current && (P.current = I, v(I));
  }, [v]), w = i || m, S = s || h, C = R.useRef(null), P = R.useRef(null), E = R.useRef(u), N = il(c), $ = il(o), T = R.useCallback(() => {
    ...
    $.current && (I.platform = $.current), Cy(C.current, P.current, I).then((F) => {
      const A = {
        ...F,
        isPositioned: !0
      };
      M.current && !eo(E.current, A) && (E.current = A, zm.flushSync(() => {
        d(A);
      }));
    });
  }, [f, t, n, $]);
...
var Et = typeof document < "u" ? bo : W;
let Ai = !1, Py = 0;
const sl = () => "floating-ui-" + Py++;
function Dy() {
  const [e, t] = R.useState(() => Ai ? sl() : void 0);
  return Et(() => {
    e == null && t(sl());
  }, []), R.useEffect(() => {
    Ai || (Ai = !0);
...
const Ry = R[/* @__PURE__ */ "useId".toString()], Ld = Ry || Dy;
function Iy() {
...
const Oy = /* @__PURE__ */ R.createContext(null), Ay = /* @__PURE__ */ R.createContext(null), Md = () => {
  var e;
  return ((e = R.useContext(Oy)) == null ? void 0 : e.id) || null;
}, Ys = () => R.useContext(Ay);
function Lt(e) {
...
function Fr(e, t, n) {
  return n && !kd(n) ? 0 : typeof e == "number" ? e : e == null ? void 0 : e[t];
}
function ky(e, t) {
  t === void 0 && (t = {});
  const {
    ...
    restMs: p = 0,
    move: m = !0
  } = t, g = Ys(), h = Md(), v = al(d), x = al(u), y = R.useRef(), w = R.useRef(), S = R.useRef(), C = R.useRef(), P = R.useRef(!0), E = R.useRef(!1), N = R.useRef(() => {
  }), $ = R.useCallback(() => {
    var O;
  ...
  const T = R.useCallback(function(O, L) {
    L === void 0 && (L = !0);
    const I = Fr(x.current, "close", y.current);
    I && !S.current ? (clearTimeout(w.current), w.current = setTimeout(() => r(!1, O), I)) : L && (clearTimeout(w.current), r(!1, O));
  }, [x, r]), M = R.useCallback(() => {
    N.current(), S.current = void 0;
  }, []), k = R.useCallback(() => {
    if (E.current) {
      const O = Lt(c.floating.current).body;
  ...
  return R.useEffect(() => {
    ...
    function L(A) {
      if (clearTimeout(w.current), P.current = !1, f && !kd(y.current) || p > 0 && Fr(x.current, "open") === 0)
        return;
  ...
  }, [s, a, l, e, f, p, m, T, M, k, r, n, g, x, v, o]), Et(() => {
    var O;
    ...
    M(), clearTimeout(w.current), clearTimeout(C.current), k();
  }, [l, M, k]), R.useMemo(() => {
    if (!l)
      return {};
    function O(L) {
...
const Bd = /* @__PURE__ */ R.createContext({
  delay: 0,
  initialDelay: 0,
  timeoutMs: 0,
  currentId: null,
  ...
  }, [o.currentId]), /* @__PURE__ */ R.createElement(Bd.Provider, {
    value: R.useMemo(() => ({
      ...o,
      setState: i,
      setCurrentId: a
...
const zy = R[/* @__PURE__ */ "useInsertionEffect".toString()], Gy = zy || ((e) => e());
function Br(e) {
  const t = R.useRef(() => {
  });
  return Gy(() => {
...
function qy(e, t) {
  ...
  const {
    ...
    ancestorScroll: h = !1,
    bubbles: v
  } = t, x = Ys(), y = Md() != null, w = Br(typeof f == "function" ? f : () => !1), S = typeof f == "function" ? w : f, C = R.useRef(!1), {
    escapeKeyBubbles: P,
    ...
    if (_d(k) && c) {
      ...
      let A = F && T.offsetX > k.clientWidth;
      if (F && Do(c).getComputedStyle(k).direction === "rtl" && (A = T.offsetX <= k.offsetWidth - k.clientWidth), A || I && T.offsetY > k.clientHeight)
        return;
    }
    const O = x && Ni(x.nodesRef.current, i).some((I) => {
      var F;
      return jr(T, (F = I.context) == null ? void 0 : F.elements.floating);
    });
    if (jr(T, c) || jr(T, a) || O)
      return;
  ...
  return R.useEffect(() => {
    ...
    let k = [];
    return h && (ht(a) && (k = Ct(a)), ht(c) && (k = k.concat(Ct(c))), !ht(s) && s && s.contextElement && (k = k.concat(Ct(s.contextElement)))), k = k.filter((O) => {
      var L;
      ...
      d && M.removeEventListener("keydown", N), S && M.removeEventListener(p, $), k.forEach((O) => {
...
function Js(e) {
  ...
  const {
    ...
    onOpenChange: r,
    nodeId: o
  } = e, [i, s] = R.useState(null), a = ((t = e.elements) == null ? void 0 : t.reference) || i, c = Ey(e), l = Ys(), u = Br((w, S) => {
    w && (f.current.openEvent = S), r == null || r(w, S);
  }), d = R.useRef(null), f = R.useRef({}), p = R.useState(() => Iy())[0], m = Ld(), g = R.useCallback((w) => {
    const S = ht(w) ? {
      getBoundingClientRect: () => w.getBoundingClientRect(),
      contextElement: w
    } : w;
    c.refs.setReference(S);
  }, [c.refs]), h = R.useCallback((w) => {
...
function Ky(e, t) {
  ...
  return R.useEffect(() => {
    if (!l)
      return;
    const g = Lt(a).defaultView || window;
    function h() {
      !n && _d(c) && c === jy(Lt(c)) && (f.current = !0);
    }
...
const tv = {}, Wd = ie((e, t) => {
  const { children: n, target: r, ...o } = j("Portal", tv, e), [i, s] = q(!1), a = V(null);
...
function Ro({ withinPortal: e = !0, children: t, ...n }) {
  return e ? /* @__PURE__ */ b.createElement(Wd, { ...n }, t) : /* @__PURE__ */ b.createElement(b.Fragment, null, t);
}
Ro.displayName = "@mantine/core/OptionalPortal";
const Vn = (e) => ({
...
function rv({
  ...
  const c = pt(), l = Qu(), u = c.respectReducedMotion ? l : !1, [d, f] = q(u ? 0 : e), [p, m] = q(r ? "entered" : "exited"), g = V(-1), h = (v) => {
...
const ov = {}, Qs = U((e, t) => {
  ...
  return f.disabled ? null : /* @__PURE__ */ b.createElement(Ro, { ...f.portalProps, withinPortal: f.withinPortal }, /* @__PURE__ */ b.createElement(
    Io,
    {
      mounted: f.opened,
      ...f.transitionProps,
    ...
    (w) => /* @__PURE__ */ b.createElement(Gd, { active: f.trapFocus }, /* @__PURE__ */ b.createElement(
      z,
      {
        ...m,
        ...d,
...
const iv = {
  ...
  const s = i, a = zd(), c = Ae(a.reference, n.ref, t), l = a.withRoles ? {
    "aria-haspopup": o,
...
function mt(e) {
  ...
  const t = j("Popover", cv, e), {
    ...
    vars: ue,
    varsResolver: lv
  }), re = V(null), [we, _e] = q(null), [Ce, Ee] = q(null), { dir: ke } = hr(), ce = St(L), X = av({
    middlewares: u,
    width: l,
    position: Vd(ke, r),
  ...
  const fn = Q(
    (ae) => {
      _e(ae), X.floating.refs.setReference(ae);
    },
  ...
  return /* @__PURE__ */ b.createElement(
    Zy,
    {
      value: {
        ...
        x: X.floating.x,
        y: X.floating.y,
        arrowX: (Pe = (Ye = (Nt = X.floating) == null ? void 0 : Nt.middlewareData) == null ? void 0 : Ye.arrow) == null ? void 0 : Pe.x,
        arrowY: (Jt = ($t = (me = X.floating) == null ? void 0 : me.middlewareData) == null ? void 0 : $t.arrow) == null ? void 0 : Jt.y,
        opened: X.opened,
        arrowRef: re,
        transitionProps: c,
        width: l,
...
const uv = ie(({ className: e, ...t }, n) => /* @__PURE__ */ b.createElement(z, { component: "span", className: xt(st.barsLoader, e), ...t, ref: n }, /* @__PURE__ */ b.createElement("span", { className: st.bar }), /* @__PURE__ */ b.createElement("span", { className: st.bar }), /* @__PURE__ */ b.createElement("span", { className: st.bar }))), dv = ie(({ className: e, ...t }, n) => /* @__PURE__ */ b.createElement(z, { component: "span", className: xt(st.dotsLoader, e), ...t, ref: n }, /* @__PURE__ */ b.createElement("span", { className: st.dot }), /* @__PURE__ */ b.createElement("span", { className: st.dot }), /* @__PURE__ */ b.createElement("span", { className: st.dot }))), fv = ie(({ className: e, ...t }, n) => /* @__PURE__ */ b.createElement(z, { component: "span", className: xt(st.ovalLoader, e), ...t, ref: n })), Kd = {
  bars: uv,
  oval: fv,
  dots: dv
}, pv = {
  ...
  return m ? /* @__PURE__ */ b.createElement(z, { ...h("root"), ref: t, ...g }, m) : /* @__PURE__ */ b.createElement(
    z,
    {
      ...h("root"),
      ref: t,
...
const xv = {
  ...
  const n = j("Group", xv, e), {
    ...
    __size: v,
    ...x
  } = n, y = wv(c), w = y.length, S = Wu(l ?? "md"), P = { childWidth: `calc(${100 / w}% - (${S} - ${S} / ${w}))` }, E = J({
    name: "Group",
    props: n,
    stylesCtx: P,
    className: o,
...
const Cv = {
  ...
  root: {
    "--overlay-bg": t || (n !== void 0 || r !== void 0) && Ie(n || "#000", r ?? 0.6) || void 0,
  ...
  return /* @__PURE__ */ b.createElement(z, { ref: t, ...y("root"), mod: { center: u, fixed: l }, ...x }, d);
});
to.classes = Qd;
...
const Nv = {
  ...
  const n = j("InputWrapper", Nv, e), {
    ...
    variant: u,
    __staticSelector: d
  }, k = St(P), O = typeof C == "boolean" ? C : E, L = (y == null ? void 0 : y.id) || `${k}-error`, I = (x == null ? void 0 : x.id) || `${k}-description`, F = k, A = !!g && typeof g != "boolean", H = !!h, K = `${A ? L : ""} ${H ? I : ""}`, ne = K.trim().length > 0 ? K.trim() : void 0, ye = (v == null ? void 0 : v.id) || `${k}-label`, ue = m && /* @__PURE__ */ b.createElement(
    $o,
    {
      key: "label",
      labelElement: w,
...
const Tv = {
  ...
  const n = j("Input", Tv, e), {
    ...
    withErrorStyles: O,
    ...L
  } = n, { styleProps: I, rest: F } = gr(L), A = Nn(), H = { offsetBottom: A == null ? void 0 : A.offsetBottom, offsetTop: A == null ? void 0 : A.offsetTop }, K = J({
    name: ["Input", l],
    props: u || n,
    classes: nt,
    className: o,
...
const _v = {
  ...
  const { inputProps: n, wrapperProps: r, ...o } = Mv("InputBase", _v, e);
...
function oe(e) {
  ...
  return /* @__PURE__ */ b.createElement(
    ...
    /* @__PURE__ */ b.createElement(z, { ...k("root"), id: E, ...P, variant: S, "data-accordion": !0 }, c)
  );
}
const Wv = (e) => e;
oe.extend = Wv;
...
function va({
  ...
  const [a, c] = Pt({
    ...
    finalValue: !1,
    onChange: n
  }), l = V(null), u = V(-1), d = V(null), f = V(null), p = V(-1), m = V(-1), g = V(-1), h = Q(
    (I = "unknown") => {
      a || (c(!0), o == null || o(I));
    },
    [c, o, a]
...
const df = Ht(null), bw = df.Provider, yw = () => ft(df);
...
const Sw = {
  ...
  const n = j("Checkbox", Sw, e), {
    ...
    onChange: $,
    ...T
  } = n, M = yw(), k = f || (M == null ? void 0 : M.size), O = P, L = J({
    name: "Checkbox",
    props: n,
    classes: pf,
    className: o,
    ...
    vars: c,
    varsResolver: Cw
  }), { styleProps: I, rest: F } = gr(T), A = St(d), H = M ? {
  ...
  return /* @__PURE__ */ b.createElement(
    ...
    /* @__PURE__ */ b.createElement(z, { ...L("inner"), mod: { "data-label-position": v } }, /* @__PURE__ */ b.createElement(
      z,
      {
        component: "input",
        id: A,
...
const Dw = {}, Rw = (e, { radius: t, color: n, gradient: r, variant: o, size: i, justify: s }) => {
  ...
  return /* @__PURE__ */ b.createElement(
    ...
    /* @__PURE__ */ b.createElement(z, { component: "span", ...C("loader"), "aria-hidden": !0 }, /* @__PURE__ */ b.createElement(
      An,
      {
    ...
    /* @__PURE__ */ b.createElement("span", { ...C("inner") }, l && /* @__PURE__ */ b.createElement(z, { component: "span", ...C("section"), mod: { position: "left" } }, l), /* @__PURE__ */ b.createElement(z, { component: "span", mod: { loading: m }, ...C("label") }, c), u && /* @__PURE__ */ b.createElement(z, { component: "span", ...C("section"), mod: { position: "right" } }, u))
  );
});
Xn.classes = Lo;
...
const Ow = {}, Aw = (e, { size: t, fluid: n }) => ({
  ...
  return /* @__PURE__ */ b.createElement(z, { ref: t, mod: { fluid: l }, ...d("root"), ...u });
});
Sa.classes = vf;
...
const yl = {
  ...
  return /* @__PURE__ */ b.createElement(Io, { transition: "fade", ...l, mounted: !!f }, (x) => /* @__PURE__ */ b.createElement(z, { ...h("root", { style: x }), ref: t, ...m }, /* @__PURE__ */ b.createElement(An, { ...h("loader"), unstyled: a, ...u }), /* @__PURE__ */ b.createElement(
    to,
    {
      ...v,
      ...h("overlay"),
...
const jw = {}, Vw = (e, { gap: t }, { size: n }) => ({
  ...
  return /* @__PURE__ */ b.createElement(Fw, { value: { size: p, disabled: u } }, /* @__PURE__ */ b.createElement(z, { ref: t, size: p, ...m("group"), ...d }));
});
Pa.classes = Mo;
...
const Ww = {
  ...
  const n = j("PillsInputField", Ww, e), {
    classNames: r,
    className: o,
    style: i,
    styles: s,
...
const Hw = {}, no = U((e, t) => {
  ...
  return /* @__PURE__ */ b.createElement(kw, { value: { fieldRef: f, size: s, disabled: a, hasError: !!l, variant: u } }, /* @__PURE__ */ b.createElement(
    Yt,
    {
      size: s,
      error: l,
...
const qw = {
  ...
  const n = j("MultiSelect", qw, e), {
    ...
    ...Tm
  } = n, bi = St(Im), yi = rf(g), Er = ca(yi), Fe = va({
    opened: h,
    defaultOpened: v,
    onDropdownOpen: x,
    onDropdownClose: () => {
    ...
    p == null || p(le), le.key === " " && !me && (le.preventDefault(), Fe.toggleDropdown()), le.key === "Backspace" && Pr.length === 0 && $e.length > 0 && kn($e.slice(0, $e.length - 1));
  }, km = $e.map((le, wi) => {
    var Ec;
    return /* @__PURE__ */ b.createElement(
      Zn,
  ...
  return /* @__PURE__ */ b.createElement(b.Fragment, null, /* @__PURE__ */ b.createElement(
    Z,
    {
      ...
      onOptionSubmit: (le) => {
        S == null || S(le), Dr(""), Fe.updateSelectedOptionIndex("selected"), $e.includes(Er[le].value) ? kn($e.filter((wi) => wi !== Er[le].value)) : $e.length < Pe && kn([...$e, Er[le].value]);
      },
      ...C
    },
    /* @__PURE__ */ b.createElement(Z.DropdownTarget, null, /* @__PURE__ */ b.createElement(
      ...
      /* @__PURE__ */ b.createElement(Zn.Group, { disabled: L, unstyled: a, ...vi("pillsList") }, km, /* @__PURE__ */ b.createElement(Z.EventsTarget, null, /* @__PURE__ */ b.createElement(
        no.Field,
        {
          ...Mm,
          ref: t,
          ...
          unstyled: a,
          onFocus: (le) => {
            I == null || I(le), me && Fe.openDropdown();
          },
          onBlur: (le) => {
    ...
    /* @__PURE__ */ b.createElement(
      bf,
      {
        ...
        search: Pr,
        limit: E,
        hiddenWhenEmpty: !me || !$t || Tt && Cc.length === 0 && Pr.trim().length === 0,
        withScrollArea: N,
        maxDropdownHeight: $,
        filterOptions: me,
        value: $e,
...
function Jw({
  ...
  const [n, r] = q(!1), o = V(), { x: i, y: s, elements: a, refs: c, update: l, placement: u } = Js({
    placement: t,
    middleware: [
      Hs({
        crossAxis: !0,
...
const Xw = {
  ...
  const n = j("TooltipFloating", Xw, e), {
    ...
    vars: w,
    varsResolver: Qw
  }), { handleMouseMove: N, x: $, y: T, opened: M, boundaryRef: k, floating: O, setOpened: L } = Jw({
    offset: m,
    position: g
  });
  if (!qt(r))
  ...
  return /* @__PURE__ */ b.createElement(b.Fragment, null, /* @__PURE__ */ b.createElement(Ro, { ...S, withinPortal: i }, /* @__PURE__ */ b.createElement(
    z,
    {
      ...C,
      ...E("tooltip", {
...
const Df = Ht(!1), Zw = Df.Provider, e0 = () => ft(Df), t0 = {
  openDelay: 0,
  closeDelay: 0
};
function Rf(e) {
...
const vl = {
  ...
  const n = j("Tooltip", vl, e), {
    ...
    portalProps: ye,
    ...ue
  } = j("Tooltip", vl, n), { dir: Ne } = hr(), ve = V(null), re = n0({
    position: Vd(Ne, o),
    closeDelay: c,
    openDelay: a,
    onPositionChange: l,
  ...
  const _e = Ae(re.reference, r.ref, t), Ce = Yw(N, { duration: 100, transition: "fade" });
  return /* @__PURE__ */ b.createElement(b.Fragment, null, /* @__PURE__ */ b.createElement(Ro, { ...ye, withinPortal: d }, /* @__PURE__ */ b.createElement(
    Io,
    {
      ...Ce,
      keepMounted: K,
...
const o0 = {
  ...
  const n = j("Select", o0, e), {
    ...
    hiddenInputProps: _e,
    ...Ce
  } = n, Ee = Mt(() => rf(g), [g]), ke = Mt(() => ca(Ee), [Ee]), ce = St(ve), [X, fn] = Pt({
    value: h,
    defaultValue: v,
    finalValue: null,
    onChange: m
  }), Ke = typeof X == "string" ? ke[X] : void 0, [Nt, Ye] = Pt({
    value: H,
    defaultValue: K,
  ...
  }), { resolvedClassNames: me, resolvedStyles: $t } = id({
    props: n,
    styles: o,
    classNames: r
  });
  ...
  return /* @__PURE__ */ b.createElement(b.Fragment, null, /* @__PURE__ */ b.createElement(
    Z,
    {
      ...
      onOptionSubmit: (ae) => {
        y == null || y(ae);
        const Tt = ye && ke[ae].value === X ? null : ke[ae].value;
        fn(Tt), Ye(typeof Tt == "string" ? ke[ae].label : ""), Pe.closeDropdown();
      },
      size: T,
      ...w
    },
    /* @__PURE__ */ b.createElement(Z.Target, { targetType: M ? "input" : "button" }, /* @__PURE__ */ b.createElement(
      Yt,
      {
        id: ce,
        ref: t,
        rightSection: k || Jt || /* @__PURE__ */ b.createElement(Z.Chevron, { size: T, error: ue, unstyled: i }),
        ...
        onBlur: (ae) => {
          var Tt;
          M && Pe.closeDropdown(), Ye(X != null && ((Tt = ke[X]) == null ? void 0 : Tt.label) || ""), f == null || f(ae);
        },
        onClick: (ae) => {
    ...
    /* @__PURE__ */ b.createElement(
      bf,
      {
        ...
        withScrollArea: N,
        maxDropdownHeight: $,
        filterOptions: M && (Ke == null ? void 0 : Ke.label) !== Nt,
        value: X,
        checkIconPosition: O,
        withCheckIcon: L,
        nothingFoundMessage: I,
...
Ia.classes = { ...Yt.classes, ...Z.classes };
Ia.displayName = "@mantine/core/Select";
const i0 = {}, er = U((e, t) => {
  const { w: n, h: r, miw: o, mih: i, ...s } = j("Space", i0, e);
  return /* @__PURE__ */ b.createElement(z, { ref: t, ...s, w: n, miw: o ?? n, h: r, mih: i ?? r });
});
...
var w0 = /* @__PURE__ */ (() => typeof Symbol == "function" && Symbol.observable || "@@observable")(), xl = w0, Li = () => Math.random().toString(36).substring(7).split("").join("."), x0 = {
  INIT: `@@redux/INIT${Li()}`,
...
function Nf(e) {
  ...
  return n === Object ? !0 : typeof n == "function" && Function.toString.call(n) === D0;
}
function tr(e, t) {
  ko(e) === 0 ? Object.entries(e).forEach(([n, r]) => {
    t(n, r, e);
...
function Ma(e, t = !1) {
  return jo(e) || Gt(e) || !It(e) || (ko(e) > 1 && (e.set = e.add = e.clear = e.delete = I0), Object.freeze(e), t && tr(e, (n, r) => Ma(r, !0))), e;
}
function I0() {
  it(2);
}
...
function fs(e) {
  ps(e), e.drafts_.forEach(N0), e.drafts_ = null;
}
function ps(e) {
  e === nr && (nr = e.parent_);
}
...
function Pl(e, t) {
  ...
  const n = t.drafts_[0];
  return e !== void 0 && e !== n ? (n[He].modified_ && (fs(t), it(4)), It(e) && (e = io(t, e), t.parent_ || so(t, e)), t.patches_ && an("Patches").generateReplacementPatches_(
    n[He].base_,
    e,
    t.patches_,
    t.inversePatches_
...
var _a = {
  get(e, t) {
    ...
    if (!us(n, t))
      return T0(e, n, t);
    const r = n[t];
    return e.finalized_ || !It(r) ? r : r === Mi(e.base_, t) ? (_i(e), e.copy_[t] = gs(r, e)) : r;
  },
  has(e, t) {
    return t in Zt(e);
  },
  ...
  set(e, t, n) {
    ...
    if (!e.modified_) {
      ...
      if (R0(n, o) && (n !== void 0 || us(e.base_, t)))
        return !0;
      _i(e), ms(e);
    }
  ...
  deleteProperty(e, t) {
    return Mi(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_[t] = !1, _i(e), ms(e)) : delete e.assigned_[t], e.copy_ && delete e.copy_[t], !0;
  },
...
function gs(e, t) {
  const n = Fo(e) ? an("MapSet").proxyMap_(e, t) : Bo(e) ? an("MapSet").proxySet_(e, t) : $0(e, t);
  return (t ? t.scope_ : Tf()).drafts_.push(n), n;
}
function Mf(e) {
  return Gt(e) || it(10, e), _f(e);
}
function _f(e) {
  if (!It(e) || jo(e))
    return e;
...
function _0(e, t = `expected an object, instead received ${typeof e}`) {
  if (typeof e != "object")
    throw new TypeError(t);
}
...
}, V0 = typeof WeakRef < "u" ? WeakRef : j0, z0 = 0, Il = 1;
function Nr() {
  return {
    s: z0,
    v: void 0,
...
function ka(e, t = {}) {
  ...
  function s() {
    ...
    if (a.s === Il ? u = a.v : (u = e.apply(null, arguments), i++), l.s = Il, r) {
      ...
      f != null && r(f, u) && (u = f, i !== 0 && i--), o = typeof u == "object" && u !== null || typeof u == "function" ? new V0(u) : u;
    }
    return l.v = u, u;
  }
  return s.clearCache = () => {
...
function Ff(e, ...t) {
  const n = typeof e == "function" ? {
    ...
    typeof l == "object" && (c = l, l = o.pop()), M0(
      l,
    ...
    const u = {
      ...
      devModeChecks: g = {}
    } = u, h = Rl(f), v = Rl(m), x = F0(o), y = d(function() {
      return i++, l.apply(
        null,
        arguments
      );
...
var Tn = /* @__PURE__ */ Ff(ka), G0 = Object.assign(
  (e, t = Tn) => {
    _0(
      e,
...
U0(ka);
var q0 = typeof window < "u" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ : function() {
  if (arguments.length !== 0)
    return typeof arguments[0] == "object" ? oo : oo.apply(null, arguments);
}, K0 = (e) => e && typeof e.match == "function";
function yt(e, t) {
  function n(...r) {
    if (t) {
      let o = t(...r);
  ...
  return n.toString = () => `${e}`, n.type = e, n.match = (r) => P0(r) && r.type === e, n;
}
...
var J0 = () => function(t) {
  ...
  let s = new jf();
  return n && (Y0(n) ? s.push(W0) : s.push(H0(n.extraArgument))), s;
}, X0 = "RTK_autoBatch", Vf = (e) => (t) => {
  setTimeout(t, e);
}, Q0 = typeof window < "u" && window.requestAnimationFrame ? window.requestAnimationFrame : Vf(10), Z0 = (e = {
  type: "raf"
}) => (t) => (...n) => {
  const r = t(...n);
  let o = !0, i = !1, s = !1;
  const a = /* @__PURE__ */ new Set(), c = e.type === "tick" ? queueMicrotask : e.type === "raf" ? Q0 : e.type === "callback" ? e.queueNotification : Vf(e.timeout), l = () => {
  ...
  return Object.assign({}, r, {
    ...
    dispatch(u) {
      var d;
      try {
        return o = !((d = u == null ? void 0 : u.meta) != null && d[X0]), i = !o, i && (s || (s = !0, c(l))), r.dispatch(u);
      } finally {
        o = !0;
      }
    }
  ...
  let o = new jf(e);
  return r && o.push(Z0(typeof r == "object" ? r : void 0)), o;
}, tx = !0;
function nx(e) {
  const t = J0(), {
    reducer: n = void 0,
...
var ix = "ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW", Gf = (e = 21) => {
  let t = "", n = e;
  for (; n--; )
    t += ix[Math.random() * 64 | 0];
  return t;
}, sx = (e, t) => K0(e) ? e.match(t) : e(t);
function ax(...e) {
  return (t) => e.some((n) => sx(n, t));
}
var cx = ["name", "message", "stack", "code"], ki = class {
  constructor(e, t) {
    /*
  ...
  function e(t, n, r) {
    const o = yt(t + "/fulfilled", (c, l, u, d) => ({
      ...
      payload: d,
      error: (r && r.serializeError || lx)(c || "Rejected"),
      meta: {
        ...f || {},
        arg: u,
        requestId: l,
    ...
    function a(c) {
      return (l, u, d) => {
        const f = r != null && r.idGenerator ? r.idGenerator(c) : Gf(), p = new AbortController();
        let m, g;
        function h(x) {
          g = x, p.abort();
        }
        const v = async function() {
          ...
          try {
            ...
            if (dx(C) && (C = await C), C === !1 || p.signal.aborted)
              throw {
                name: "ConditionError",
            ...
            l(i(f, c, (S = r == null ? void 0 : r.getPendingMeta) == null ? void 0 : S.call(r, {
              ...
              signal: p.signal,
              abort: h,
              rejectWithValue: (E, N) => new ki(E, N),
            ...
            x = C instanceof ki ? s(null, f, c, C.payload, C.meta) : s(C, f, c);
          } finally {
...
var fx = Symbol.for("rtk-slice-createasyncthunk");
function px(e, t) {
  return `${e}/${t}`;
}
function mx({
  ...
  var n;
  const t = (n = e == null ? void 0 : e.asyncThunk) == null ? void 0 : n[fx];
  return function(o) {
    const {
      name: i,
      reducerPath: s = i
    ...
    typeof process < "u";
    const a = (typeof o.reducers == "function" ? o.reducers(hx()) : o.reducers) || {}, c = Object.keys(a), l = {
    ...
    c.forEach((y) => {
      ...
      yx(w) ? wx(S, w, u, t) : bx(S, w, u);
    });
    function d() {
      const [y = {}, w = [], S = void 0] = typeof o.extraReducers == "function" ? zf(o.extraReducers) : [o.extraReducers], C = {
        ...y,
        ...l.sliceCaseReducersByType
      };
      return ox(o.initialState, (P) => {
        for (let E in C)
          P.addCase(E, C[E]);
...
var xx = (e, t) => {
  ...
  withTypes: () => Cx
}), Ex = Object.assign(yt(`${Ba}/add`), {
  withTypes: () => Ex
});
yt(`${Ba}/removeAll`);
var Px = Object.assign(yt(`${Ba}/remove`), {
  withTypes: () => Px
});
function Le(e) {
...
}, Va = yt("settings/setSettings"), Wf = Fa({
  name: "settings",
  initialState: Ox,
  reducers: {
...
const Ax = (e) => e.settings.mainDictionary, Nx = (e) => e.settings.includeTestDictionaries;
Wf.actions;
const $x = Wf.reducer, hs = 500, Tx = 500;
let nn = null, Vr = {};
const Tl = {
  classes: {},
  dictionaries: {},
...
}, bs = Vo("bsdd/fetchDictionaries", ({ bsddApiEnvironment: e, includeTestDictionaries: t }, n) => {
  if (console.log("fetchDictionaries", e), !e)
    return n.rejectWithValue("No bsddApiEnvironment provided");
  const r = new ja(e), o = Tx;
  let i = 0;
  const s = [];
...
const Yf = (e, t) => e.bsdd.dictionaries[t], Mx = (e, t) => e.bsdd.dictionaryClasses[t], Jf = (e) => e.bsdd.dictionaries, _x = (e) => e.bsdd.loaded, { resetState: kx } = Kf.actions;
function Fx(e) {
  return (t) => {
    nn = new ja(e), Vr = {}, t(kx());
  };
...
async function zx(e, t, n) {
  ...
  const r = await jx(e.referencedSource, n, t);
  if (!r)
  ...
  return l ? (c.referencedSource = za(l), {
...
function Ml(e, t) {
  if (!(t != null && t.ifcClassification.location))
    return null;
  const n = Yf(e, t.ifcClassification.location), r = za(n);
  return {
    parameterMapping: t.parameterMapping,
    ifcClassification: r
  };
}
const Ga = wg, ct = ug, Gx = {
  ifcEntities: null
}, Xf = Fa({
  name: "ifcData",
  initialState: Gx,
...
}), Wx = (e) => e.ifcData.ifcEntities, { setIfcData: Hx } = Xf.actions;
function Ux(e) {
...
function Kx(e, t) {
  return {
    ...
    identification: qx(e.type, e.predefinedType),
    referencedSource: t
  };
}
...
const Jx = Vo(
  ...
  async (e, { dispatch: t, getState: n }) => {
    const r = n(), o = await Promise.all(
      e.map(async (i) => {
        var c;
        i.type && (i.type = Ux(i.type));
        const s = [
          ...i.hasAssociations || [],
          Kx(i, (c = r.settings.ifcDictionary) == null ? void 0 : c.ifcClassification)
        ], a = await Yx(s, t, r);
...
var Qf = { exports: {} }, Qx = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED", Zx = Qx, eS = Zx;
function Zf() {
}
function ep() {
}
...
var rS = {
...
}, oS = Object.defineProperty, iS = Object.defineProperties, sS = Object.getOwnPropertyDescriptors, ao = Object.getOwnPropertySymbols, tp = Object.prototype.hasOwnProperty, np = Object.prototype.propertyIsEnumerable, _l = (e, t, n) => t in e ? oS(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, kl = (e, t) => {
  for (var n in t || (t = {}))
    tp.call(t, n) && _l(e, n, t[n]);
  if (ao)
    for (var n of ao(t))
      np.call(t, n) && _l(e, n, t[n]);
  return e;
}, aS = (e, t) => iS(e, sS(t)), cS = (e, t) => {
  var n = {};
  for (var r in e)
  ...
  const r = ie(
    (o, i) => {
      var s = o, { color: a = "currentColor", size: c = 24, stroke: l = 2, children: u } = s, d = cS(s, ["color", "size", "stroke", "children"]);
      return Pc(
        "svg",
        kl(aS(kl({
          ref: i
...
}, lS = zo("grip-vertical", "IconGripVertical", [
...
function hS({ item: e, index: t, setCardColor: n }) {
  var m;
  const { t: r } = Ut(), o = ct(Uf), i = ct(Ax), [s, a] = q("grey"), [c, l] = q([]), [u, d] = q([]);
  W(() => {
    function g(h) {
      a(h), n(t, h);
    }
  ...
  return /* @__PURE__ */ _.jsxs(xn, { mt: "xs", justify: "space-between", className: "flexGroup", children: [
    /* @__PURE__ */ _.jsx(Qn, { size: "1.5em", color: ys[s] }),
    /* @__PURE__ */ _.jsxs(on, { position: "bottom-end", shadow: "md", children: [
      /* @__PURE__ */ _.jsx(on.Target, { children: /* @__PURE__ */ _.jsx("div", { className: "flexTextContainer", children: /* @__PURE__ */ _.jsx(Qe, { className: "truncate", children: e.name }) }) }),
      /* @__PURE__ */ _.jsxs(on.Dropdown, { children: [
        ...
        o.map((g, h) => {
          ...
          return /* @__PURE__ */ _.jsxs(xn, { mt: "xs", justify: "space-between", className: "flexGroup", children: [
            /* @__PURE__ */ _.jsx(Qn, { size: "1em", color: ys[u[h]] }),
            /* @__PURE__ */ _.jsx("div", { className: "flexTextContainer", children: /* @__PURE__ */ _.jsx(Qe, { className: "truncate", children: g.ifcClassification.name }) })
          ] }, v);
        })
      ] })
    ] }),
    /* @__PURE__ */ _.jsx(Cn, { label: r("Attach to type"), children: /* @__PURE__ */ _.jsx(
      Jn,
      {
        radius: "xl",
        onClick: () => f(e),
        disabled: !((m = i == null ? void 0 : i.ifcClassification) != null && m.location),
        children: /* @__PURE__ */ _.jsx(dS, { size: 20 })
      }
    ) }),
    /* @__PURE__ */ _.jsx(Cn, { label: r("Select objects"), children: /* @__PURE__ */ _.jsx(Jn, { radius: "xl", onClick: () => p(e), children: /* @__PURE__ */ _.jsx(fS, { size: 20 }) }) })
  ] });
}
function bS({ category: e, items: t, index: n }) {
  const { t: r } = Ut(), [o, i] = q("grey"), [s, a] = q(new Array(t.length).fill("grey")), c = Q((l, u) => {
    a((d) => {
      const f = [...d];
      return f[l] = u, f;
    });
  ...
  }, [s]), /* @__PURE__ */ _.jsxs(oe.Item, { value: n, children: [
    /* @__PURE__ */ _.jsx(oe.Control, { children: /* @__PURE__ */ _.jsxs(xn, { justify: "space-between", className: "flexGroup", children: [
      /* @__PURE__ */ _.jsx(Qn, { size: "1.5em", color: ys[o], children: /* @__PURE__ */ _.jsx(Qe, { size: "xs", c: "white", children: t.length }) }),
      /* @__PURE__ */ _.jsx("div", { className: "flexTextContainer", children: /* @__PURE__ */ _.jsx(Qe, { className: "truncate", children: e.length > 0 ? e : r("No description") }) })
    ] }) }),
    /* @__PURE__ */ _.jsx(oe.Panel, { mt: "-xs", pl: "xl", children: t.map((l, u) => /* @__PURE__ */ _.jsx(hS, { item: l, index: u, setCardColor: c }, u)) })
  ] }, e);
}
function yS(e, t) {
...
function vS({ loading: e }) {
  const t = ct(Wx), n = Mt(() => t ? Object.entries(yS(t, "description")).map(([i, s], a) => /* @__PURE__ */ _.jsx(bS, { category: i, items: s, index: i || a.toString() }, i)) : [], [t]), r = /* @__PURE__ */ _.jsx(uS, {});
  return /* @__PURE__ */ _.jsx(at.Panel, { value: "link", children: /* @__PURE__ */ _.jsxs(z, { pos: "relative", style: { height: "100vh" }, children: [
    /* @__PURE__ */ _.jsx(Ca, { visible: e || !t }),
    t && n.length === 0 ? /* @__PURE__ */ _.jsxs(aa, { title: "No entities selected...", icon: r, mt: "xl", children: [
      "Select entities by using the buttons at the top of the panel.",
      /* @__PURE__ */ _.jsx(er, { h: "md" }),
      "Need help?",
      " ",
      /* @__PURE__ */ _.jsx(
        "a",
    ...
    ] }) : /* @__PURE__ */ _.jsx(oe, { chevronPosition: "left", children: n })
  ] }) });
}
const rp = "https://identifier.buildingsmart.org/uri/buildingsmart/ifc/", wS = "Export Type to IFC As";
function Fl(e, t) {
...
function CS({
  ...
  const { t: i } = Ut(), s = ct(Jf), a = ct(Wa), c = ct(xS), l = ct(SS), u = Mt(() => {
    var v, x;
  ...
  }, [t]), f = Mt(() => (t == null ? void 0 : t.filterDictionaries.map(
    (h) => ({
    ...
    (h) => {
      var C;
      const v = h[0], x = Fl(Object.values(s), v) || null, y = ((C = t.ifcDictionary) == null ? void 0 : C.parameterMapping) || wS, w = Fi(
        x,
  ...
  return W(() => {
    a.length !== 0 && o(!1);
  }, [a, o]), /* @__PURE__ */ _.jsxs(oe.Item, { value: e.toString(), children: [
    /* @__PURE__ */ _.jsxs(oe.Control, { children: [
      /* @__PURE__ */ _.jsx($n, { order: 5, children: i("Dictionary selection") }),
...
var AS = typeof Object.is == "function" ? Object.is : OS, NS = Pn.useState, $S = Pn.useEffect, TS = Pn.useLayoutEffect, LS = Pn.useDebugValue;
function MS(e, t) {
  var n = t(), r = NS({ inst: { value: n, getSnapshot: t } }), o = r[0].inst, i = r[1];
  return TS(function() {
...
var kS = typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u" ? _S : MS;
ap.useSyncExternalStore = Pn.useSyncExternalStore !== void 0 ? Pn.useSyncExternalStore : kS;
sp.exports = ap;
var cp = sp.exports, FS = {};
/**
 * @license React
...
var VS = typeof Object.is == "function" ? Object.is : jS, zS = BS.useSyncExternalStore, GS = Go.useRef, WS = Go.useEffect, HS = Go.useMemo, US = Go.useDebugValue;
FS.useSyncExternalStoreWithSelector = function(e, t, n, r, o) {
  var i = GS(null);
  if (i.current === null) {
    var s = { hasValue: !1, value: null };
    i.current = s;
...
let lp = qS;
const KS = (e) => lp = e, YS = () => lp, Hl = Symbol.for("react-redux-context"), Ul = typeof globalThis < "u" ? globalThis : (
  /* fall back to a per-module scope (pre-8.1 behaviour) if `globalThis` is not available */
  {}
);
function JS() {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var pe = typeof Symbol == "function" && Symbol.for, Ha = pe ? Symbol.for("react.element") : 60103, Ua = pe ? Symbol.for("react.portal") : 60106, Wo = pe ? Symbol.for("react.fragment") : 60107, Ho = pe ? Symbol.for("react.strict_mode") : 60108, Uo = pe ? Symbol.for("react.profiler") : 60114, qo = pe ? Symbol.for("react.provider") : 60109, Ko = pe ? Symbol.for("react.context") : 60110, qa = pe ? Symbol.for("react.async_mode") : 60111, Yo = pe ? Symbol.for("react.concurrent_mode") : 60111, Jo = pe ? Symbol.for("react.forward_ref") : 60112, Xo = pe ? Symbol.for("react.suspense") : 60113, QS = pe ? Symbol.for("react.suspense_list") : 60120, Qo = pe ? Symbol.for("react.memo") : 60115, Zo = pe ? Symbol.for("react.lazy") : 60116, ZS = pe ? Symbol.for("react.block") : 60121, eC = pe ? Symbol.for("react.fundamental") : 60117, tC = pe ? Symbol.for("react.responder") : 60118, nC = pe ? Symbol.for("react.scope") : 60119;
function qe(e) {
  if (typeof e == "object" && e !== null) {
    var t = e.$$typeof;
    switch (t) {
...
ee.isValidElementType = function(e) {
  return typeof e == "string" || typeof e == "function" || e === Wo || e === Yo || e === Uo || e === Ho || e === Xo || e === QS || typeof e == "object" && e !== null && (e.$$typeof === Zo || e.$$typeof === Qo || e.$$typeof === qo || e.$$typeof === Ko || e.$$typeof === Jo || e.$$typeof === eC || e.$$typeof === tC || e.$$typeof === nC || e.$$typeof === ZS);
};
ee.typeOf = qe;
dp.exports = ee;
var rC = dp.exports, Ka = rC, oC = {
  childContextTypes: !0,
  contextType: !0,
  contextTypes: !0,
  defaultProps: !0,
...
Ya[Ka.Memo] = pp;
function ql(e) {
  return Ka.isMemo(e) ? pp : Ya[e.$$typeof] || oC;
}
var aC = Object.defineProperty, cC = Object.getOwnPropertyNames, Kl = Object.getOwnPropertySymbols, lC = Object.getOwnPropertyDescriptor, uC = Object.getPrototypeOf, Yl = Object.prototype;
function mp(e, t, n) {
  if (typeof t != "string") {
    if (Yl) {
      var r = uC(t);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var Ja = Symbol.for("react.element"), Xa = Symbol.for("react.portal"), ei = Symbol.for("react.fragment"), ti = Symbol.for("react.strict_mode"), ni = Symbol.for("react.profiler"), ri = Symbol.for("react.provider"), oi = Symbol.for("react.context"), fC = Symbol.for("react.server_context"), ii = Symbol.for("react.forward_ref"), si = Symbol.for("react.suspense"), ai = Symbol.for("react.suspense_list"), ci = Symbol.for("react.memo"), li = Symbol.for("react.lazy"), pC = Symbol.for("react.offscreen"), hp;
...
te.isValidElementType = function(e) {
  return typeof e == "string" || typeof e == "function" || e === ei || e === ni || e === ti || e === si || e === ai || e === pC || typeof e == "object" && e !== null && (e.$$typeof === li || e.$$typeof === ci || e.$$typeof === ri || e.$$typeof === oi || e.$$typeof === ii || e.$$typeof === hp || e.getModuleId !== void 0);
};
te.typeOf = ot;
gp.exports = te;
var mC = gp.exports;
const gC = ["initMapStateToProps", "initMapDispatchToProps", "initMergeProps"];
function hC(e, t, n, r, {
  areStatesEqual: o,
  areOwnPropsEqual: i,
...
function CC(e) {
  return e ? typeof e == "function" ? SC(e) : Qa(e, "mergeProps") : () => xC;
}
function EC() {
  const e = YS();
  let t = null, n = null;
...
function yp(e, t) {
  ...
  function u() {
    o++, n || (n = t ? t.addNestedSub(c) : e.subscribe(c), r = EC());
  }
  function d() {
...
const PC = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", co = PC ? R.useLayoutEffect : R.useEffect;
function Zl(e, t) {
...
function NC(e, t, n, r, o, i, s, a, c, l, u) {
  if (!e)
    return () => {
    };
  let d = !1, f = null;
...
function wp(e, t, n, {
  ...
  const u = l, d = wC(e), f = vC(t), p = CC(n), m = !!e;
  return (h) => {
    ...
    function w(P) {
      ...
      mC.isContextConsumer(/* @__PURE__ */ R.createElement(E.Consumer, null)) ? E : u, [E, u]), M = R.useContext(T), k = !!P.store && !!P.store.getState && !!P.store.dispatch, O = !!M && !!M.store, L = k ? P.store : M.store, I = O ? M.getServerState : L.getState, F = R.useMemo(() => bC(L.dispatch, y), [L]), [A, H] = R.useMemo(() => {
        if (!m)
          return IC;
        const ce = yp(L, k ? void 0 : M.subscription), X = ce.notifyNestedSubs.bind(ce);
        return [ce, X];
      }, [L, k, M]), K = R.useMemo(() => k ? M : _t({}, M, {
        subscription: A
      }), [k, M, A]), ne = R.useRef(), ye = R.useRef($), ue = R.useRef(), Ne = R.useRef(!1);
      R.useRef(!1);
      const ve = R.useRef(!1), re = R.useRef();
      co(() => (ve.current = !0, () => {
        ve.current = !1;
      }), []);
      const we = R.useMemo(() => () => ue.current && $ === ye.current ? ue.current : F(L.getState(), $), [L, $]), _e = R.useMemo(() => (X) => A ? NC(
        m,
        L,
        A,
        // @ts-ignore
...
`), ce;
      ...
      const Ee = R.useMemo(() => (
        // @ts-ignore
        /* @__PURE__ */ R.createElement(h, _t({}, Ce, {
          ref: N
        }))
      ), [N, h, Ce]);
    ...
    if (C.WrappedComponent = h, C.displayName = w.displayName = x, c) {
      const E = R.forwardRef(function($, T) {
        return /* @__PURE__ */ R.createElement(C, _t({}, $, {
...
function xp(e, t) {
  ...
  })[0], r = V(!0), o = V(n), i = r.current || !!(t && o.current.inputs && LC(t, o.current.inputs)), s = i ? o.current : {
    inputs: t,
    result: e()
  };
  return W(function() {
...
var Y = xp, G = MC, _C = !0, zi = "Invariant failed";
function kC(e, t) {
  if (!e) {
    if (_C)
      throw new Error(zi);
    var n = typeof t == "function" ? t() : t, r = n ? "".concat(zi, ": ").concat(n) : zi;
    throw new Error(r);
  }
}
var lt = function(t) {
  ...
  var n = t.borderBox, r = t.margin, o = r === void 0 ? Gi : r, i = t.border, s = i === void 0 ? Gi : i, a = t.padding, c = a === void 0 ? Gi : a, l = lt(Za(n, o)), u = lt(eu(n, s)), d = lt(eu(u, c));
  return {
    marginBox: l,
    borderBox: lt(n),
    paddingBox: u,
  ...
  var r = t.borderBox, o = t.border, i = t.margin, s = t.padding, a = FC(r, n);
  return ec({
    borderBox: a,
    border: o,
    margin: i,
...
const fe = {
  ...
  x: n,
  y: t
}, sr = (e, t) => Math.sqrt((t.x - e.x) ** 2 + (t.y - e.y) ** 2), ru = (e, t) => Math.min(...t.map((n) => sr(e, n))), Rp = (e) => (t) => ({
  x: e(t.x),
  y: e(t.y)
});
var XC = (e, t) => {
...
const Sr = (e, t) => ({
  ...
  bottom: 0,
  left: 0
}, ZC = (e, t) => t ? Sr(e, t.scroll.diff.displacement) : e, e1 = (e, t, n) => n && n.increasedBy ? {
  ...e,
  [t.end]: e[t.end] + n.increasedBy[t.line]
} : e, t1 = (e, t) => t && t.shouldClipSubject ? XC(t.pageMarginBox, e) : lt(e);
var Dn = ({
  page: e,
  withPlaceholder: t,
  axis: n,
  ...
  const o = ZC(e.marginBox, r), i = e1(o, n, t), s = t1(i, r);
  return {
    page: e,
    withPlaceholder: t,
    active: s
...
const Ip = de((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), Op = de((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), ui = de((e) => Object.values(e)), n1 = de((e) => Object.values(e));
var Mn = de((e, t) => n1(t).filter((r) => e === r.descriptor.droppableId).sort((r, o) => r.descriptor.index - o.descriptor.index));
function nc(e) {
...
var fi = de((e, t) => t.filter((n) => n.descriptor.id !== e.descriptor.id)), r1 = ({
  isMovingForward: e,
  draggable: t,
  destination: n,
  insideDestination: r,
...
var i1 = o1, Ze = (e, t) => (n) => e <= n && n <= t, Np = (e) => {
...
const c1 = (e, t) => {
  ...
  return Sr(e, n);
}, l1 = (e, t, n) => t.subject.active ? n(t.subject.active)(e) : !1, u1 = (e, t, n) => n(t)(e), oc = ({
  target: e,
  destination: t,
  viewport: n,
  ...
  const i = r ? c1(e, t) : e;
  return l1(i, t, o) && u1(i, n, o);
}, d1 = (e) => oc({
  ...e,
  isVisibleThroughFrameFn: Np
}), Tp = (e) => oc({
  ...e,
  isVisibleThroughFrameFn: s1
}), f1 = (e) => oc({
  ...e,
  isVisibleThroughFrameFn: a1(e.destination.axis)
}), p1 = (e, t, n) => {
  if (typeof n == "boolean")
    return n;
  if (!t)
...
function cr({
  ...
  return e.reduce(function(a, c) {
    const l = m1(c, n), u = c.descriptor.id;
    if (a.all.push(u), !d1({
      target: l,
      destination: t,
      viewport: r,
...
var h1 = ({
  ...
  return Wt(n, t) ? o ? fe : Ln(r.point) : o ? r.point : fe;
}, w1 = ({
  afterCritical: e,
  impact: t,
  draggables: n
  ...
  const r = di(t);
  r || B(!1);
  const o = r.draggableId, i = n[o].page.borderBox.center, s = v1({
...
const Lp = (e, t) => t.margin[e.start] + t.borderBox[e.size] / 2, x1 = (e, t) => t.margin[e.end] + t.borderBox[e.size] / 2, ic = (e, t, n) => t[e.crossAxisStart] + n.margin[e.crossAxisStart] + n.borderBox[e.crossAxisSize] / 2, su = ({
  axis: e,
  moveRelativeTo: t,
  isMoving: n
  ...
  moveRelativeTo: t,
  isMoving: n
}) => cn(e.line, t.marginBox[e.start] - x1(e, n), ic(e, t.marginBox, n)), S1 = ({
  axis: e,
  moveInto: t,
  isMoving: n
...
const E1 = ({
  ...
  return !n || !s ? i : s.type === "REORDER" ? C1({
    impact: e,
    draggable: t,
    draggables: r,
    droppable: n,
...
var D1 = ({
...
}, R1 = (e, t) => he(e.scroll.diff.displacement, t), sc = ({
  pageBorderBoxCenter: e,
  draggable: t,
  viewport: n
}) => {
  const r = R1(n, e), o = je(r, t.page.borderBox.center);
  ...
  if (!n.isEnabled)
    return null;
  const l = Mn(n.descriptor.id, r), u = _n(t, n), d = r1({
    isMovingForward: e,
    draggable: t,
    destination: n,
    insideDestination: l,
...
var O1 = ({
  ...
  if (!i)
    return null;
  const s = n.axis, a = Ze(i[s.start], i[s.end]), c = ui(r).filter((u) => u !== n).filter((u) => u.isEnabled).filter((u) => !!u.subject.active).filter((u) => Np(o.frame)(Re(u))).filter((u) => {
    const d = Re(u);
  ...
  if (c.length === 1)
    return c[0];
  const l = c.filter((u) => Ze(Re(u)[s.start], Re(u)[s.end])(t[s.line]));
  return l.length === 1 ? l[0] : l.length > 1 ? l.sort((u, d) => Re(u)[s.start] - Re(d)[s.start])[0] : c.sort((u, d) => {
    const f = ru(t, ou(Re(u))), p = ru(t, ou(Re(d)));
    return f !== p ? f - p : Re(u)[s.start] - Re(d)[s.start];
  })[0];
};
const lu = (e, t) => {
  const n = e.page.borderBox.center;
  return Wt(e.descriptor.id, t) ? je(n, t.displacedBy.point) : n;
}, A1 = (e, t) => {
  const n = e.page.borderBox;
  return Wt(e.descriptor.id, t) ? Sr(n, Ln(t.displacedBy.point)) : n;
};
var N1 = ({
  pageBorderBoxCenter: e,
  viewport: t,
...
const $1 = (e, t, n) => {
  ...
  const o = Cr(e.axis, t.displaceBy).point, i = $1(e, o, n), s = {
    placeholderSize: o,
    increasedBy: i,
  ...
  const a = i ? he(r.scroll.max, i) : r.scroll.max, c = kp(r, a), l = Dn({
    page: e.subject.page,
    withPlaceholder: s,
    axis: e.axis,
    frame: c
...
var L1 = ({
  ...
  if (!c)
    return null;
  const l = Mn(c.descriptor.id, o), u = N1({
    pageBorderBoxCenter: t,
    viewport: s,
    destination: c,
    insideDestination: l,
...
var k1 = ({
  ...
  const n = _1(e.impact, e.dimensions.droppables), r = !!n, o = e.dimensions.droppables[e.critical.droppable.id], i = n || o, s = i.axis.direction, a = s === "vertical" && (t === "MOVE_UP" || t === "MOVE_DOWN") || s === "horizontal" && (t === "MOVE_LEFT" || t === "MOVE_RIGHT");
  if (a && !r)
    return null;
...
var G1 = ({
  ...
  const a = n.axis, c = Cr(n.axis, t.displaceBy), l = c.value, u = e[a.start], d = e[a.end], p = fi(t, r).find((g) => {
    const h = g.descriptor.id, v = g.page.borderBox.center[a.line], x = Wt(h, s), y = Vp({
      displaced: o,
      id: h
    });
...
var H1 = ({
  ...
  const s = r.axis, a = Cr(r.axis, e.displaceBy), c = a.value, l = t[s.start], u = t[s.end], f = fi(e, o).find((m) => {
    const g = m.descriptor.id, h = m.page.borderBox, x = h[s.size] / W1, y = Wt(g, i), w = Vp({
  ...
  const a = jp(t.page.borderBox, e), c = j1({
    pageBorderBox: a,
    draggable: t,
    droppables: r
  });
  if (!c)
    return i1;
  const l = r[c], u = Mn(l.descriptor.id, n), d = V1(l, a);
  return H1({
...
var q1 = ({
  ...
  const p = a.draggables[e.critical.draggable.id], m = o || zp({
    pageOffset: d.offset,
    draggable: p,
...
var Gp = ({
  ...
  const i = e.displaced, s = K1(i.all, n), a = cr({
    afterDragging: s,
    destination: r,
    displacedBy: e.displacedBy,
    viewport: t.frame,
  ...
  const r = e.impact, o = n || e.viewport, i = t || e.dimensions, {
    draggables: s,
    droppables: a
  } = i, c = s[e.critical.draggable.id], l = Ge(r);
  l || B(!1);
  const u = a[l], d = Gp({
    impact: r,
    viewport: o,
  ...
  return e.map((o) => {
    const i = o.descriptor.droppableId, s = t[i], c = Q1(s).scroll.diff.value, l = he(r, c);
    return X1({
      draggable: o,
      offset: l,
  ...
  const s = {
    droppables: r,
    draggables: i
  }, a = Ge(e.impact), c = a ? s.droppables[a] : null, l = s.draggables[e.critical.draggable.id], u = s.droppables[e.critical.droppable.id], {
    impact: d,
    afterCritical: f
  } = Up({
    draggable: l,
    ...
    draggables: i,
    viewport: e.viewport
  }), p = c && c.isCombineEnabled ? e.impact : d, m = zp({
...
const xs = (e) => e.movementMode === "SNAP", Wi = (e, t, n) => {
  const r = J1(e.dimensions, t);
  return !xs(e) || n ? qn({
    state: e,
    dimensions: r
  }) : Hp({
...
}, du = (e) => Ft(e, fe) ? void 0 : `translate(${e.x}px, ${e.y}px)`, Ss = {
  moveTo: du,
  drop: (e, t) => {
    const n = du(e);
    if (n)
...
var SE = ({
  ...
  if (r >= fu)
    return Xp;
  const o = r / fu, i = Cs + wE * o, s = n === "CANCEL" ? i * xE : i;
  ...
  const {
    draggables: i,
    droppables: s
  } = n, a = Ge(e), c = a ? s[a] : null, l = s[t.descriptor.droppableId], u = Wp({
    impact: e,
    draggable: t,
    draggables: i,
    afterCritical: o,
...
const PE = ({
  ...
  if (!(!Ft(o.current.client.offset, h) || !!g.combine)) {
    t(lc({
      completed: v
    }));
    return;
...
const OE = (e) => e.type === "DROP_COMPLETE" || e.type === "DROP_ANIMATE" || e.type === "FLUSH", AE = (e) => {
  const t = IE({
    onWindowScroll: (n) => {
      e.dispatch(uE({
        newScroll: n
  ...
  return (n) => (r) => {
    !t.isActive() && r.type === "INITIAL_PUBLISH" && t.start(), t.isActive() && OE(r) && t.stop(), n(r);
  };
};
var NE = AE, $E = (e) => {
  let t = !1, n = !1;
...
const LE = (e, t) => e == null && t == null ? !0 : e == null || t == null ? !1 : e.droppableId === t.droppableId && e.index === t.index, ME = (e, t) => e == null && t == null ? !0 : e == null || t == null ? !1 : e.draggableId === t.draggableId && e.droppableId === t.droppableId, _E = (e, t) => {
  if (e === t)
    return !0;
...
var kE = (e, t) => {
  ...
  const o = (d, f) => {
    ...
    r = {
      ...
      zn("onDragStart", () => Ui(e().onDragStart, p, t, zr.onDragStart));
    });
  }, a = (d, f) => {
    const p = nc(f), m = di(f);
    r || B(!1);
    const g = !_E(d, r.lastCritical);
    g && (r.lastCritical = d);
    const h = !LE(r.lastLocation, p);
    h && (r.lastLocation = p);
    const v = !ME(r.lastCombine, m);
    ...
    n.add(() => {
      zn("onDragUpdate", () => Ui(e().onDragUpdate, x, t, zr.onDragUpdate));
    });
  }, c = () => {
    r || B(!1), n.flush();
  }, l = (d) => {
    r || B(!1), r = null, zn("onDragEnd", () => Ui(e().onDragEnd, d, t, zr.onDragEnd));
  };
  return {
    beforeCapture: o,
    beforeStart: i,
...
const HE = (e) => e.type === "DROP_COMPLETE" || e.type === "DROP_ANIMATE" || e.type === "FLUSH";
var UE = (e) => (t) => (n) => (r) => {
  if (HE(r)) {
    e.stop(), n(r);
    return;
...
var JE = ({
  ...
  announce: o,
  autoScroller: i
}) => op(tE, YE(IS(vE(n), GE(e), yE(e), DE, jE, zE, KE, UE(i), NE, WE(t), FE(r, o))));
const qi = () => ({
  additions: {},
  removals: {},
  modified: {}
...
var Zp = ({
  ...
  const r = QE(), o = r.scroll.current, i = e.droppable, s = n.droppable.getAllByType(i.type).map((u) => u.callbacks.getDimensionAndWatchScroll(o, t)), a = n.draggable.getAllByType(e.draggable.type).map((u) => u.getDimension(o));
  return {
    dimensions: {
      draggables: Op(a),
      droppables: Ip(s)
...
}, nm = (e, t) => e.phase === "IDLE" ? !0 : e.phase !== "DROP_ANIMATING" || e.completed.result.draggableId === t ? !1 : e.completed.result.reason === "DROP", tP = (e) => {
  window.scrollBy(e.x, e.y);
};
const nP = de((e) => ui(e).filter((t) => !(!t.isEnabled || !t.frame))), rP = (e, t) => nP(t).find((r) => (r.frame || B(!1), Bp(r.frame.pageMarginBox)(e))) || null;
var oP = ({
  center: e,
  destination: t,
  droppables: n
...
var iP = (e, t, n = () => ur) => {
  ...
  const i = sP(e, t, o);
  return i === 0 ? 0 : r ? Math.max(aP(i, n, o), dc) : i;
}, gu = ({
  container: e,
  distanceToEdges: t,
  dragStartTime: n,
...
var om = ({
  ...
  return u ? Ft(u, fe) ? null : u : null;
};
const uP = Rp((e) => e === 0 ? 0 : e > 0 ? 1 : -1), fc = (() => {
...
const SP = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? bo : W;
var We = SP;
const Ki = () => {
...
function CP(e, t) {
  const n = Y(() => xP(e), [e]), r = V(null), o = V(null), i = G(de((d) => {
    const f = o.current;
  ...
  We(() => {
    ...
    const d = yu(t), f = yu(t);
    return r.current = d, o.current = f, d.setAttribute(`${Rn}-always`, e), f.setAttribute(`${Rn}-dynamic`, e), Ki().appendChild(d), Ki().appendChild(f), s(n.always), i(n.resting), () => {
      const p = (m) => {
        const g = m.current;
...
function EP(e, t) {
  const n = `[${In.contextId}="${e}"]`, r = sm(document, n);
  if (!r.length)
    return null;
...
var OP = IP;
const AP = (e) => `rfd-announcement-${e}`;
function NP(e) {
  const t = Y(() => AP(e), [e]), n = V(null);
  return W(function() {
    const i = document.createElement("div");
    return n.current = i, i.id = t, i.setAttribute("aria-live", "assertive"), i.setAttribute("aria-atomic", "true"), _t(i.style, OP), go().appendChild(i), function() {
      setTimeout(function() {
        const c = go();
...
function TP(e, t = cm) {
  return Y(() => `${e}${t.separator}${$P++}`, [t.separator, e]);
}
function LP(e, t = cm) {
  const n = b.useId();
  return Y(() => `${e}${t.separator}${n}`, [t.separator, e, n]);
}
var hc = "useId" in b ? LP : TP;
function MP({
  contextId: e,
  uniqueId: t
}) {
...
const FP = 9, BP = 13, bc = 27, um = 32, jP = 33, VP = 34, zP = 35, GP = 36, WP = 37, HP = 38, UP = 39, qP = 40, KP = {
  [BP]: !0,
  [FP]: !0
};
var dm = (e) => {
...
function aD(e) {
  const t = V(Yi), n = V(kt), r = G(function() {
    return t.current;
  }, []), o = G(function(p) {
    t.current = p;
  }, []), i = Y(() => ({
    ...
    const p = {
      ...
      completed: a,
      getPhase: r
    }, g = Xe(window, sD(m), p), h = Xe(window, iD(m), p);
    n.current = function() {
      g(), h();
    };
  }, [c, r, a]), u = G(function() {
...
const cD = ["input", "button", "textarea", "select", "option", "optgroup", "video", "audio"];
function pm(e, t) {
  if (t == null)
    return !1;
  if (cD.includes(t.tagName.toLowerCase()))
    return !0;
...
var uD = (e) => lt(e.getBoundingClientRect()).center;
function dD(e) {
...
function mm(e, t) {
  return e == null ? null : e[fD](t) ? e : mm(e.parentElement, t);
}
function pD(e, t) {
...
function vD({
  ...
  if (!gm({
    ...
    return null;
  const c = r.draggable.getById(o), l = bD(t, c.descriptor.id);
  if (!l || s && !c.options.canDragInteractiveElements && lD(l, s))
    return null;
  const u = e.claim(i || kt);
  let d = "PRE_DRAG";
  function f() {
  ...
  function h(S) {
    ...
    d !== "PRE_DRAG" && (C(), B(!1)), n.dispatch(rE(S.liftActionArgs)), d = "DRAGGING";
    function P(E, N = {
...
function xD({
  ...
  const i = [...o ? wD : [], ...r || []], s = q(() => kP())[0], a = G(function(h, v) {
...
function ED(e) {
  ...
  } = e, s = V(null), a = lm(e), c = G(() => SD(a.current), [a]), l = G(() => CD(a.current), [a]), u = NP(t), d = _P({
    contextId: t,
    text: i
  }), f = CP(t, o), p = G(($) => {
    Wn(s).dispatch($);
  }, []), m = Y(() => Wl({
    publishWhileDragging: iE,
    updateDroppableScroll: aE,
    updateDroppableIsEnabled: cE,
    updateDroppableIsCombineEnabled: lE,
    collectionStarting: sE
  }, p), [p]), g = RP(), h = Y(() => eP(g, m), [g, m]), v = Y(() => bP({
    scrollWindow: tP,
  ...
  }), [h.scrollDroppable, p, l]), x = PP(t), y = Y(() => JE({
    announce: u,
    autoScroller: v,
    dimensionMarshal: h,
    focusMarshal: x,
  ...
  n(C);
  const P = G(($) => nm(Wn(s).getState(), $), []), E = G(() => en(Wn(s).getState()), []), N = Y(() => ({
    marshal: h,
    focus: x,
    contextId: t,
    canLift: P,
  ...
  }), W(() => w, [w]), b.createElement(gi.Provider, {
    value: N
  }, b.createElement(TC, {
    context: gc,
    store: y
...
var ID = "useId" in b ? RD : DD;
function OD(e) {
  const t = ID(), n = e.dragHandleUsageInstructions || zr.dragHandleUsageInstructions;
  return b.createElement(HC, null, (r) => b.createElement(ED, {
    nonce: e.nonce,
    contextId: t,
    setCallbacks: r,
...
const xu = {
  dragging: 5e3,
  dropAnimating: 4500
}, AD = (e, t) => t ? Kn.drop(t.duration) : e ? Kn.snap : Kn.fluid, ND = (e, t) => {
  if (e)
...
function TD(e) {
  const n = e.dimension.client, {
    ...
    combineWith: o,
    dropping: i
  } = e, s = !!o, a = $D(e), c = !!i, l = c ? Ss.drop(r, s) : Ss.moveTo(r);
  return {
    position: "fixed",
    top: n.marginBox.top,
...
function MD(e) {
  return e.type === "DRAGGING" ? TD(e) : LD(e);
}
function _D(e, t, n = fe) {
...
const VD = (e) => e.combine ? e.combine.draggableId : null, zD = (e) => e.at && e.at.type === "COMBINE" ? e.at.combine.draggableId : null;
function GD() {
  const e = de((o, i) => ({
    x: o,
    y: i
  ...
  return (o, i) => {
    if (dr(o)) {
      if (o.critical.draggable.id !== i.draggableId)
        return null;
      const s = o.current.client.offset, a = o.dimensions.draggables[i.draggableId], c = Ge(o.impact), l = zD(o.impact), u = o.forceShouldAnimate;
    ...
    if (o.phase === "DROP_ANIMATING") {
      ...
      if (s.result.draggableId !== i.draggableId)
        return null;
      const a = i.isClone, c = o.dimensions.draggables[i.draggableId], l = s.result, u = l.mode, d = bm(l), f = VD(l), m = {
...
var YD = KD;
function vm(e) {
  return ho(yc).isUsingCloneFor === e.draggableId && !e.isClone ? null : b.createElement(YD, e);
}
function JD(e) {
...
const wm = (e) => (t) => e === t, XD = wm("scroll"), QD = wm("auto"), Su = (e, t) => t(e.overflowX) || t(e.overflowY), ZD = (e) => {
  const t = window.getComputedStyle(e), n = {
    overflowX: t.overflowX,
    overflowY: t.overflowY
  };
  return Su(n, XD) || Su(n, QD);
}, eR = () => !1, xm = (e) => e == null ? null : e === document.body ? eR() ? e : null : e === document.documentElement ? null : ZD(e) ? e : xm(e.parentElement);
var tR = xm, Ps = (e) => ({
  x: e.scrollLeft,
  y: e.scrollTop
});
...
var iR = ({
  ...
  const c = n.closestScrollable, l = oR(e, c), u = uo(l, r), d = (() => {
    if (!c)
      return null;
    const p = Cp(c), m = {
...
var Cu = (e) => e.shouldPublishImmediately ? sR : aR;
const Mr = (e) => e && e.env.closestScrollable || null;
function cR(e) {
  const t = V(null), n = ho(gi), r = hc("droppable"), {
    registry: o,
    marshal: i
  } = n, s = lm(e), a = Y(() => ({
    id: e.droppableId,
    type: e.type,
    mode: e.mode
  }), [e.droppableId, e.mode, e.type]), c = V(a), l = Y(() => de((w, S) => {
    t.current || B(!1);
    const C = {
      x: w,
      y: S
  ...
  We(() => (c.current = y.descriptor, o.droppable.register(y), () => {
...
const Eu = {
  ...
  W(() => a ? r !== "open" ? (n(), c(!1), Ji) : t.current ? Ji : (t.current = setTimeout(() => {
    t.current = null, c(!1);
  }), n) : Ji, [r, a, n]);
  const l = G((d) => {
...
var fR = b.memo(dR);
class pR extends b.PureComponent {
  constructor(...t) {
    super(...t), this.state = {
...
const Pu = {
  ...
  return t;
}, Xi = (e, t) => e === t.droppable.type, Du = (e, t) => t.draggables[e.draggable.id], bR = () => {
  const e = {
    placeholder: null,
  ...
  return (i, s) => {
    ...
    if (dr(i)) {
      ...
      if (!Xi(l, f))
        return t;
      const p = Du(f, i.dimensions), m = Ge(i.impact) === c;
    ...
    if (i.phase === "DROP_ANIMATING") {
      ...
      return r(c, u, bm(f.result) === c, Ge(f.impact) === c, p, d);
    }
    if (i.phase === "IDLE" && i.completed && !i.shouldFlush) {
      const f = i.completed;
      if (!Xi(l, f.critical))
        return t;
      const p = Ge(f.impact) === c, m = !!(f.impact.at && f.impact.at.type === "COMBINE"), g = f.critical.droppable.id === c;
      return p ? m ? e : t : g ? e : t;
    }
    return t;
  };
}, yR = {
  updateViewportMaxScroll: dE
}, vR = wp(bR, yR, (e, t, n) => ({
  ...Cm(n),
  ...e,
  ...t
...
const SR = "_item_1o9ja_1", CR = "_itemDragging_1o9ja_12", ER = "_symbol_1o9ja_16", PR = "_dragHandle_1o9ja_22", _r = {
  item: SR,
  itemDragging: CR,
  symbol: ER,
  dragHandle: PR
};
function DR({ id: e, localSettings: t, setLocalSettings: n, setUnsavedChanges: r }) {
  const { t: o } = Ut(), i = t ? t.filterDictionaries : [], s = (c) => {
    if (!t || !c.destination)
      return;
    const l = Array.from(i), [u] = l.splice(c.source.index, 1);
    l.splice(c.destination.index, 0, u), n({ ...t, filterDictionaries: l }), r(!0);
  }, a = i.map((c, l) => /* @__PURE__ */ _.jsx(JD, { index: l, draggableId: c.ifcClassification.location, children: (u, d) => /* @__PURE__ */ _.jsxs(
    "div",
    {
      className: xR(_r.item, { [_r.itemDragging]: d.isDragging }),
      ref: u.innerRef,
      ...u.draggableProps,
      children: [
        /* @__PURE__ */ _.jsx("div", { ...u.dragHandleProps, className: _r.dragHandle, children: /* @__PURE__ */ _.jsx(lS, { style: { width: D(18), height: D(18) }, stroke: 1.5 }) }),
        /* @__PURE__ */ _.jsx(Qe, { className: _r.uri, children: c.ifcClassification.location })
      ]
    }
  ) }, c.ifcClassification.location));
  return /* @__PURE__ */ _.jsxs(oe.Item, { value: e.toString(), children: [
    /* @__PURE__ */ _.jsxs(oe.Control, { children: [
      /* @__PURE__ */ _.jsx($n, { order: 5, children: o("Sort filter dictionaries") }),
      /* @__PURE__ */ _.jsx(Qe, { size: "xs", c: "dimmed", children: o("Sort filter dictionaries help text") })
    ] }),
    /* @__PURE__ */ _.jsx(oe.Panel, { children: /* @__PURE__ */ _.jsx(OD, { onDragEnd: s, children: /* @__PURE__ */ _.jsx(wR, { droppableId: "dnd-list", direction: "vertical", children: (c) => /* @__PURE__ */ _.jsxs("div", { ...c.droppableProps, ref: c.innerRef, children: [
      a,
      c.placeholder
    ] }) }) }) })
  ] }, e);
}
function RR({ settings: e, setSettings: t, setUnsavedChanges: n }) {
  const { t: r, i18n: o } = Ut(), i = [
...
function IR({ id: e, localSettings: t, setLocalSettings: n, setUnsavedChanges: r }) {
  const { t: o } = Ut(), i = Ga(), s = ct(Hf), a = ct(Nx), c = V();
  return W(() => {
    s && i(Fx(s));
  }, [i, s]), W(() => {
    if (!s)
  ...
  }, [i, s, a]), /* @__PURE__ */ _.jsxs(oe.Item, { value: e.toString(), children: [
    /* @__PURE__ */ _.jsxs(oe.Control, { children: [
      /* @__PURE__ */ _.jsx($n, { order: 5, children: o("General settings") }),
      /* @__PURE__ */ _.jsx(Qe, { size: "xs", c: "dimmed", children: o("General settings help text") })
    ] }),
    /* @__PURE__ */ _.jsxs(oe.Panel, { children: [
      /* @__PURE__ */ _.jsx(RR, { settings: t, setSettings: n, setUnsavedChanges: r }),
      " ",
      /* @__PURE__ */ _.jsx(er, { h: "xs" }),
      /* @__PURE__ */ _.jsx(
        To,
...
function OR({
  ...
  const { t: o } = Ut(), { mainDictionary: i, filterDictionaries: s } = t, [a, c] = q([]);
  W(() => {
  ...
  return /* @__PURE__ */ _.jsxs(oe.Item, { value: e.toString(), children: [
    /* @__PURE__ */ _.jsxs(oe.Control, { children: [
      /* @__PURE__ */ _.jsx($n, { order: 5, children: o("Parameter mapping") }),
      /* @__PURE__ */ _.jsx(Qe, { size: "xs", c: "dimmed", children: o("Parameter mapping help text") })
    ] }),
    /* @__PURE__ */ _.jsx(oe.Panel, { children: a.map((u, d) => {
      const f = u.ifcClassification.location || d;
      return /* @__PURE__ */ _.jsxs("div", { style: { marginBottom: "1em" }, children: [
        /* @__PURE__ */ _.jsx(
          Ta,
          {
...
function AR() {
  ...
  return /* @__PURE__ */ _.jsxs(at.Panel, { value: "settings", children: [
    ...
    /* @__PURE__ */ _.jsxs(xn, { my: "sm", justify: "center", children: [
      /* @__PURE__ */ _.jsx(
        Xn,
        {
          fullWidth: !0,
      ...
      /* @__PURE__ */ _.jsx(Xn, { fullWidth: !0, variant: "light", onClick: l, disabled: !o, children: "Cancel" })
    ] })
  ] });
}
let NR;
...
function TR() {
  const e = Ga(), { t } = Ut(), n = ct(_x), [r, o] = q(null), [i, s] = q(null), [a, c] = q(!0);
  return W(() => {
    (async () => {
      try {
      } catch (u) {
    ...
    n && r && (e($R(r)), o(null), c(!1));
  }, [n, r, e]), W(() => {
    !a && i && (e(Jx(i)), s(null));
  }, [a, i, e]), console.log("isProduction", y0), W(() => {
    s([]);
  }, []), W(() => {
    (async () => {
      var d;
  ...
  }, /* @__PURE__ */ _.jsx(Sa, { size: "40rem", children: /* @__PURE__ */ _.jsxs(at, { defaultValue: "link", children: [
    /* @__PURE__ */ _.jsxs(at.List, { grow: !0, children: [
      /* @__PURE__ */ _.jsx(at.Tab, { value: "link", children: t("Link") }),
      /* @__PURE__ */ _.jsx(at.Tab, { value: "settings", children: t("Settings") })
    ] }),
    /* @__PURE__ */ _.jsx(vS, { loading: a }),
    /* @__PURE__ */ _.jsx(AR, {})
  ] }) });
}
function LR() {
  return /* @__PURE__ */ _.jsx(od, { theme: b0, children: /* @__PURE__ */ _.jsx(TR, {}) });
}
const MR = nx({
  reducer: {
    settings: $x,
...
Qi.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ _.jsx(b.StrictMode, { children: /* @__PURE__ */ _.jsx(bg, { store: MR, children: /* @__PURE__ */ _.jsx(LR, {}) }) })
);
