...
var rS = /* @__PURE__ */ (() => typeof Symbol == "function" && Symbol.observable || "@@observable")(), _l = rS, Bi = () => Math.random().toString(36).substring(7).split("").join("."), oS = {
  INIT: `@@redux/INIT${Bi()}`,
...
function Qs(n, e = !1) {
  return Si(n) || bn(n) || !tn(n) || (bi(n) > 1 && (n.set = n.add = n.clear = n.delete = dS), Object.freeze(n), e && Object.entries(n).forEach(([t, r]) => Qs(r, !0))), n;
}
function dS() {
  Rt(2);
}
...
function ka(n) {
  Aa(n), n.drafts_.forEach(pS), n.drafts_ = null;
}
function Aa(n) {
  n === Qr && (Qr = n.parent_);
}
...
var Js = {
  ...
  set(n, e, t) {
    ...
    if (!n.modified_) {
      ...
      if (uS(t, o) && (t !== void 0 || Ta(n.base_, e)))
        return !0;
      $i(n), Ra(n);
    }
...
function Pa(n, e) {
  const t = Ci(n) ? Un("MapSet").proxyMap_(n, e) : wi(n) ? Un("MapSet").proxySet_(n, e) : gS(n, e);
...
function vS(n, e = `expected a function, instead received ${typeof n}`) {
  if (typeof n != "function")
    throw new TypeError(e);
}
function bS(n, e = `expected an object, instead received ${typeof n}`) {
  if (typeof n != "object")
    throw new TypeError(e);
}
function CS(n, e = "expected all items to be functions, instead received the following types: ") {
...
function Xs(n, e = {}) {
  ...
  function a() {
    ...
    if (s.s === Ol)
      ...
      d != null && r(d, u) && (u = d, i !== 0 && i--), o = typeof u == "object" && u !== null || typeof u == "function" ? new IS(u) : u;
    }
...
var Sn = /* @__PURE__ */ bf(Xs), _S = Object.assign(
  (n, e = Sn) => {
    bS(
      n,
...
}, NS = (n) => n && typeof n.match == "function";
function Ut(n, e) {
  function t(...r) {
    if (e) {
      let o = e(...r);
  ...
  return t.toString = () => `${n}`, t.type = n, t.match = (r) => cS(r) && r.type === n, t;
}
...
var OS = () => function(e) {
...
}, xS = "RTK_autoBatch", Sf = (n) => (e) => {
  setTimeout(e, n);
}, DS = typeof window < "u" && window.requestAnimationFrame ? window.requestAnimationFrame : Sf(10), LS = (n = {
  type: "raf"
}) => (e) => (...t) => {
  const r = e(...t);
  let o = !0, i = !1, a = !1;
  const s = /* @__PURE__ */ new Set(), c = n.type === "tick" ? queueMicrotask : n.type === "raf" ? DS : n.type === "callback" ? n.queueNotification : Sf(n.timeout), l = () => {
  ...
  return Object.assign({}, r, {
    ...
    dispatch(u) {
      var f;
      try {
        return o = !((f = u == null ? void 0 : u.meta) != null && f[xS]), i = !o, i && (a || (a = !0, c(l))), r.dispatch(u);
      } finally {
        o = !0;
      }
    }
  ...
  let o = new wf(n);
  return r && o.push(LS(typeof r == "object" ? r : void 0)), o;
}, jS = !0;
function US(n) {
  const e = OS(), {
    reducer: t = void 0,
...
var zS = "ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW", If = (n = 21) => {
  let e = "", t = n;
  for (; t--; )
    e += zS[Math.random() * 64 | 0];
  return e;
}, $S = (n, e) => NS(n) ? n.match(e) : n(e);
function KS(...n) {
  return (e) => n.some((t) => $S(t, e));
}
var qS = ["name", "message", "stack", "code"], Ki = class {
  ...
  function n(e, t, r) {
    const o = Ut(e + "/fulfilled", (c, l, u, f) => ({
      ...
      payload: f,
      error: (r && r.serializeError || VS)(c || "Rejected"),
      meta: {
        ...d || {},
        arg: u,
        requestId: l,
...
function JS({
  ...
  var t;
  const e = (t = n == null ? void 0 : n.asyncThunk) == null ? void 0 : t[YS];
  return function(o) {
    const {
      name: i,
      reducerPath: a = i
...
)), ec = (n) => n.settings.mainDictionary, Af = (n) => n.settings.language, f0 = (n) => n.settings.includeTestDictionaries, h0 = Sn(
  kf,
...
}), v0 = sn("bsdd/fetchDictionaries", async ({ bsddApiEnvironment: n, dictionaryUris: e }, t) => {
  if (!n || !e || e.length === 0)
...
const b0 = async (n, e, t) => {
  ...
  async ({ location: n, languageCode: e }, { getState: t, dispatch: r }) => {
    ...
    const a = b0(i, n, e).then((s) => (r({ type: "bsdd/addDictionaryClasses", payload: { uri: n, data: s } }), s)).finally(() => {
      delete bo[n];
    });
    return bo[n] = a, a;
  }
...
), Mf = (n) => n.bsdd.mainDictionaryClassification, w0 = (n) => n.bsdd.mainDictionaryClassificationUri, Of = (n) => n.bsdd.dictionaries, S0 = (n) => n.bsdd.classes, E0 = (n) => n.bsdd.propertyNamesByLanguage, I0 = Sn([S0], (n) => Object.values(n).reduce((r, o) => {
...
}), A0 = (n) => n.ifcEntity, nc = (n) => n.ifcEntity.isDefinedBy, Lf = (n) => n.ifcEntity.hasAssociations, R0 = Sn(
  Lf,
...
function O0({ callback: n, ifcEntity: e }) {
  const { t } = Zr();
  Ne(Of);
  ...
  function i(s) {
    ...
    return c.isDefinedBy = r == null ? void 0 : r.filter((l) => l.name !== "Attributes"), c.hasAssociations = [], o == null || o.forEach((l) => {
      ...
      if (l.type === "IfcClassificationReference" && ((f = (u = l == null ? void 0 : l.referencedSource) == null ? void 0 : u.location) != null && f.includes("https://identifier.buildingsmart.org/uri/buildingsmart/ifc/"))) {
        const { type: h, predefinedType: p } = nS(l.identification);
...
const $l = 25, x0 = 25;
function D0({ height: n, options: e, label: t, value: r, setValue: o, placeholder: i = "Search values", disabled: a }) {
...
function L0({ height: n, handleMouseDown: e }) {
  const t = so(), { t: r } = Zr(), [o, i] = te(/* @__PURE__ */ new Map()), [a, s] = te(/* @__PURE__ */ new Map()), c = Ne(d0), l = Ne(R0), u = Pn(Of), f = Pn(I0), d = Pn(Mf), h = Pn(p0);
  return X(() => {
    (async () => {
...
}), { setLoadedIfcEntities: j0 } = Ff.actions, U0 = (n) => n.ifcData.loadedIfcEntities, jf = Sn(U0, (n) => n[0]), H0 = Ff.reducer;
function Vi(n, e) {
  return n == null || e == null ? null : n.toLowerCase() !== e.toLowerCase() ? `(${e})` : null;
}
function B0({ label: n, description: e, value: t, setValue: r, disabled: o }) {
...
function z0({ propertySet: n, property: e, property_natural_language_name: t }) {
...
function V0(n, e, t, r) {
  ...
  const a = n.predefinedValue ? [Jo(n.dataType, n.predefinedValue)] : q0(
    n.dataType,
    r,
    t,
    e,
...
function G0(n, e, t, r) {
  ...
  }, i = n.predefinedValue ? Jo(n.dataType, n.predefinedValue) : K0(n.dataType, r, t, e);
  return i !== null && (o.nominalValue = i), o;
}
function W0(n, e, t) {
  const { propertyCode: r } = n, o = r || "unknown", i = n.allowedValues ? V0(n, o, e, t) : G0(n, o, e, t);
  return i.specification = n.propertyUri || "", i;
}
function Y0({ mainDictionaryClassification: n, recursiveMode: e }) {
  const t = so(), r = Ne(jf), o = Ne(nc), i = Ne(E0), a = Ne(Af), [s, c] = te({});
  return X(() => {
    if (!n)
      return;
    const l = {};
...
function Q0({ api: n, defaultSelection: e }) {
...
let Kl = 0, ql = 0;
function J0() {
  const { t: n } = Zr(), e = so(), [t, r] = te(), [o, i] = te(!1), [a, s] = te(new Yr(lf[tS])), c = Ne(ec), l = Ne(Af), [u, f] = te(null), d = Ne(Na), h = Ne(Na), p = Ne(f0), g = Ne(h0), m = Ne(A0), b = Ne(jf), C = Ne(w0), [v, w] = te(Wi), [S, E] = te("auto"), k = Ne(Mf), T = me((R) => {
    var _;
  ...
  return /* @__PURE__ */ y.jsxs(Ks, { children: [
    ...
    /* @__PURE__ */ y.jsx(Gr, { mx: "md", mt: "lg", mb: "sm", children: /* @__PURE__ */ y.jsx(Q0, { api: a, defaultSelection: t }) }),
...
function X0() {
  ...
  return X(() => {
    const t = new lm(Jw);
    e(t);
  }, []), n ? /* @__PURE__ */ y.jsx(Du, { theme: Qw, children: /* @__PURE__ */ y.jsx(J0, {}) }) : /* @__PURE__ */ y.jsx("div", { children: "Loading..." });
}
const Z0 = US({
  reducer: {
    settings: g0,
